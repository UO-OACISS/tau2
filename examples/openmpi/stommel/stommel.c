...
*/
    ...
    TAU_PROFILE_TIMER(jac, "do_jacobi()",
      "void (FLT **, FLT **, FLT **, INT, INT, INT, INT)", TAU_DEFAULT);
#pragma omp parallel
    { 
      TAU_PROFILE_TIMER(par, "OpenMP Parallel for (do_jacobi)", " ", TAU_DEFAULT);
      TAU_PROFILE_START(jac);
