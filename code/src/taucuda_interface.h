...
extern "C" void enter_cu_event(const char *functionName, cuEventId id, gpuId device);

/* Exit point for cu* routines */
extern "C" void exit_cu_event(const char *functionName, cuEventId id, gpuId device);
