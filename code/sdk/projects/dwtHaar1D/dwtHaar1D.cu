...
runTest( int argc, char** argv) 
{
    ...
    CUDA_SAFE_CALL( cudaMalloc( (void**) &d_idata, smem_size));
    CUDA_SAFE_CALL( cudaMalloc( (void**) &d_odata, smem_size));
    // copy input data to device
    CUDA_SAFE_CALL( cudaMemcpy( d_idata, signal, smem_size, 
    ...
    CUDA_SAFE_CALL( cudaMemcpy( d_odata, tmp, smem_size, 
                                cudaMemcpyHostToDevice) ); 
    free( tmp);
    ...
    CUDA_SAFE_CALL( cudaMemcpy( odata, d_odata, smem_size, 
