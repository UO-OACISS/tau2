             ...
             int whichKernel, T *d_idata, T *d_odata)
{
    ...
    case 0:
        ...
        break;
    case 1:
        FUNC(reduce1)<<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 2:
        FUNC(reduce2)<<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 3:
        FUNC(reduce3)<<< dimGrid, dimBlock, smemSize >>>(d_idata, d_odata);
        break;
    case 4:
        switch (threads)
        {
