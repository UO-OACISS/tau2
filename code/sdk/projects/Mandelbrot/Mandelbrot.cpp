...
void displayFunc(void)
{
    ...
    if (pass < 128) {
        ...
        if (pass && !startPass) // Use the adaptive sampling version when animating.
            RunMandelbrotDSGold1(h_Src, imageW, imageH, crunch, x, y, s, colors, pass++, animationFrame, mode);
        else
            RunMandelbrotDSGold0(h_Src, imageW, imageH, crunch, x, y, s, colors, pass++, animationFrame, mode);
    ...
    if (pass < 128) {
        ...
        do {
            ...
            if (!haveDoubles) {
                ...
                if (pass && !startPass) // Use the adaptive sampling version when animating.
                    RunMandelbrot1_sm13(d_dst, imageW, imageH, crunch, x, y, s, colors, pass++, animationFrame, mode);
                else
                    RunMandelbrot0_sm13(d_dst, imageW, imageH, crunch, x, y, s, colors, pass++, animationFrame, mode);
            }
