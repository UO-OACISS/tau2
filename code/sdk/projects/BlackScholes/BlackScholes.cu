...
int main(int argc, char **argv){
    ...
    printf("Initializing data...\n");
        ...
        CUDA_SAFE_CALL( cudaMalloc((void **)&d_PutResult,    OPT_SZ) );
    ...
    printf("Executing Black-Scholes GPU kernel (%i iterations)...\n", NUM_ITERATIONS);
        ...
        for(i = 0; i < NUM_ITERATIONS; i++){
            ...
            CUT_CHECK_ERROR("BlackScholesGPU() execution failed\n");
        }
        CUDA_SAFE_CALL( cudaThreadSynchronize() );
    ...
    printf("Reading back GPU results...\n");
        ...
        CUDA_SAFE_CALL( cudaMemcpy(h_PutResultGPU,  d_PutResult,  OPT_SZ, cudaMemcpyDeviceToHost) );
    ...
    printf("Shutting down...\n");
        ...
        CUDA_SAFE_CALL( cudaFree(d_PutResult)    );
