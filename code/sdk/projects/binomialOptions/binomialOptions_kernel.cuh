...
static void binomialOptionsGPU(
    ...
    CUDA_SAFE_CALL( cudaMemcpyToSymbol(d_OptionData, h_OptionData, optN * sizeof(__TOptionData)) );
    binomialOptionsKernel<<<optN, CACHE_SIZE>>>();
    CUT_CHECK_ERROR("binomialOptionsKernel() execution failed.\n");
    CUDA_SAFE_CALL( cudaMemcpyFromSymbol(callValue, d_CallValue, optN * sizeof(float)) );
}
