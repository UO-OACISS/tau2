...
int main(int argc, char **argv){
    ...
    int deviceIndex;
    CUDA_SAFE_CALL(cudaGetDevice(&deviceIndex));
    cudaDeviceProp deviceProp;
    CUDA_SAFE_CALL(cudaGetDeviceProperties(&deviceProp, deviceIndex));
    ...
    printf("Allocating GPU memory...\n");
        CUDA_SAFE_CALL( cudaMalloc((void **)&d_Output, QRNG_DIMENSIONS * N * sizeof(float)) );
    ...
    printf("Testing QRNG...\n");
        CUDA_SAFE_CALL( cudaMemset(d_Output, 0, QRNG_DIMENSIONS * N * sizeof(float)) );
    ...
    printf("Reading GPU results...\n");
        CUDA_SAFE_CALL( cudaMemcpy(h_OutputGPU, d_Output, QRNG_DIMENSIONS * N * sizeof(float), cudaMemcpyDeviceToHost) );
