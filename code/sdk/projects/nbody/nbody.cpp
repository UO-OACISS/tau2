...
void init(int numBodies, int p, int q, bool bUsePBO)
{
    ...
    CUT_SAFE_CALL(cutCreateTimer(&demoTimer));

    CUT_SAFE_CALL(cutStartTimer(demoTimer));
}
...
void selectDemo(int index)
{
    ...
    CUT_SAFE_CALL(cutResetTimer(demoTimer));
}
...
main( int argc, char** argv) 
{
    ...
    CUT_SAFE_CALL(cutDeleteTimer(demoTimer));
