 ...
 *
 *  @brief      This file contains Fortran specific functions needed to handle
 *              OpenMP pragmas.*/
...
/** @brief Split combined parallel and worksharing pragmas in two seperate pragmas to
 *         allow POMP function calls in between.*/
OMPragma*
