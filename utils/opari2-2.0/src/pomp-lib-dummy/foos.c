 ...
 *
 *  @brief     This file is used to check the Fotran mangling of the used compiler.
 *             In getfname.f a Function foo_foo is called. Here functions with 
 *             mangled names exist foo_foo, foo_foo_, _foo_foo_, ... , depending
 *             on the function called a file pomp2_fwrapper_def.h is written with
 *             a macro to mangle function names to fortran function names.*/
