      ...
      char** argv )
{
    ...
    if ( otf2_NOLOCALDEFS && ( otf2_MAPPINGS || otf2_CLOCK_OFFSETS ) )
    {
        ...
        printf( "Try 'otf2-print --help' for information on usage.\n\n" );
        exit( EXIT_FAILURE );
    }
             ...
             uint32_t            regionID )
{
    ...
    printf( "%-*s %15" PRIu64 " %20" PRIu64 "  Region: %s\n",
              ...
              const OTF2_MetricValue* values )
{
    ...
    for ( uint8_t i = 0; i < numberOfMetrics; i++ )
    {
        ...
        {
            case OTF2_TYPE_INT64:
                printf( "%s(INT64; %" PRId64 ")", sep, values[ i ].signed_int );
                break;
            case OTF2_TYPE_UINT64:
                printf( "%s(UINT64; %" PRIu64 ")", sep, values[ i ].unsigned_int );
                break;
            case OTF2_TYPE_DOUBLE:
                    ...
                    const uint64_t* members )
{
    ...
    printf( "%-*s %12u  Name: %s, Type: %s, %u Members:",
                              ...
                              uint64_t trace_length )
{
    ...
    printf( "%-*s %12s  Ticks per Seconds: %" PRIu64 ", "
