...
#ifdef TAU_ENABLE_OPENSHMEM_PSHMEM_CHAR_P
...
#endif /* TAU_ENABLE_OPENSHMEM_PSHMEM_CHAR_P */
/**********************************************************
   shmem_short_p
 **********************************************************/
...
/**********************************************************
   shmem_char_g
 **********************************************************/
#ifdef TAU_ENABLE_OPENSHMEM_SHMEM_CHAR_G 
...
#endif /* TAU_ENABLE_OPENSHMEM_SHMEM_CHAR_G  */
