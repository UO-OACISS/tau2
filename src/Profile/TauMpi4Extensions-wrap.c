...
int recvcount, MPI_Datatype recvtype, int source, int recvtag, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Isendrecv(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source,
...
MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Isendrecv(sendbuf, /* MPI_HANDLE_TYPES */ sendcount, /* MPI_HANDLE_TYPES */ sendtype,
    /* MPI_HANDLE_TYPES */ dest, /* MPI_HANDLE_TYPES */ sendtag, recvbuf,
    /* MPI_HANDLE_TYPES */ recvcount, /* MPI_HANDLE_TYPES */ recvtype,
    /* MPI_HANDLE_TYPES */ source, /* MPI_HANDLE_TYPES */ recvtag, /* MPI_HANDLE_TYPES */ comm,
    request);
  return ;
}
...
******************************************************/
void MPI_ISENDRECV_REPLACE(MPI_Aint buf, MPI_Fint count, MPI_Fint datatype, MPI_Fint dest, MPI_Fint sendtag, MPI_Fint source,
MPI_Fint recvtag, MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{

  *ierr = MPI_Isendrecv_replace(buf, /* MPI_HANDLE_TYPES */ count, /* MPI_HANDLE_TYPES */ datatype,
...
******************************************************/
void mpi_isendrecv_replace_(MPI_Aint buf, MPI_Fint count, MPI_Fint datatype, MPI_Fint dest, MPI_Fint sendtag, MPI_Fint source,
MPI_Fint recvtag, MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{
  MPI_ISENDRECV_REPLACE(buf, count, datatype, dest, sendtag, source, recvtag, comm, request, ierr);
  return ;
...
******************************************************/
void mpi_isendrecv_replace__(MPI_Aint buf, MPI_Fint count, MPI_Fint datatype, MPI_Fint dest, MPI_Fint sendtag, MPI_Fint source,
MPI_Fint recvtag, MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{
  MPI_ISENDRECV_REPLACE(buf, count, datatype, dest, sendtag, source, recvtag, comm, request, ierr);
  return ;
...
void MPI_COMM_IDUP_WITH_INFO(MPI_Fint comm, MPI_Fint info, MPI_Comm* newcomm, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Comm_idup_with_info(/* MPI_HANDLE_TYPES */ comm, /* MPI_HANDLE_TYPES */ info, newcomm,
    request);
  return ;
}
...
void MPI_INFO_GET_STRING(MPI_Fint info, char* key, int* buflen, char* value, int* flag, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Info_get_string(/* MPI_HANDLE_TYPES */ info, key, buflen, value, flag);
  return ;
}
...
void MPI_INFO_CREATE_ENV(MPI_Fint argc, char **argv, MPI_Info* info, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Info_create_env(/* MPI_HANDLE_TYPES */ argc, argv, info);
  return ;
}
...
MPI_Aint target_disp, MPI_Count target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Accumulate_c(origin_addr, origin_count, origin_datatype, target_rank, target_disp,
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Accumulate_c(origin_addr, origin_count, /* MPI_HANDLE_TYPES */ origin_datatype,
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Raccumulate_c(origin_addr, origin_count, origin_datatype, target_rank, target_disp,
...
MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Raccumulate_c(origin_addr, origin_count, /* MPI_HANDLE_TYPES */ origin_datatype,
    /* MPI_HANDLE_TYPES */ target_rank, target_disp, target_count,
    /* MPI_HANDLE_TYPES */ target_datatype, /* MPI_HANDLE_TYPES */ op, /* MPI_HANDLE_TYPES */ win,
    request);
  return ;
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allgather_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf, recvcount,
    /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm);
  return ;
}
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Iallgather_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf, recvcount,
    /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm, request);
  return ;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Allgather_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allgather_init(sendbuf, /* MPI_HANDLE_TYPES */ sendcount,
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Allgather_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allgather_init_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allgatherv_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf, recvcounts,
    displs, /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm);
  return ;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Iallgatherv_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Iallgatherv_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
...
TAU_MPICH3_CONST int displs[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Allgatherv_init(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allgatherv_init(sendbuf, /* MPI_HANDLE_TYPES */ sendcount,
...
MPI_Fint * ierr)
{
  MPI_ALLGATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm,
    info, request, ierr);
  return ;
}
...
MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Allgatherv_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allgatherv_init_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allreduce_c(sendbuf, recvbuf, count, /* MPI_HANDLE_TYPES */ datatype,
...
MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Iallreduce_c(sendbuf, recvbuf, count, /* MPI_HANDLE_TYPES */ datatype,
...
MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allreduce_init(sendbuf, recvbuf, /* MPI_HANDLE_TYPES */ count,
...
MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Allreduce_init_c(sendbuf, recvbuf, count, /* MPI_HANDLE_TYPES */ datatype,
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoall_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf, recvcount,
    /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm);
  return ;
}
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Ialltoall_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf, recvcount,
    /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm, request);
  return ;
}
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoall_init(sendbuf, /* MPI_HANDLE_TYPES */ sendcount,
    /* MPI_HANDLE_TYPES */ sendtype, recvbuf, /* MPI_HANDLE_TYPES */ recvcount,
    /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm, /* MPI_HANDLE_TYPES */ info,
    request);
  return ;
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoall_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint recvtype, MPI_Fint comm, MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoall_init_c(sendbuf, sendcount, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
    recvcount, /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm,
    /* MPI_HANDLE_TYPES */ info, request);
  return ;
}
...
******************************************************/
int MPI_Alltoallv_c(TAU_MPICH3_CONST void* sendbuf, TAU_MPICH3_CONST MPI_Count sendcounts[], TAU_MPICH3_CONST MPI_Aint sdispls[], MPI_Datatype sendtype,
...
MPI_Comm comm)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoallv_c(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype,
    comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint comm, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoallv_c(sendbuf, sendcounts, sdispls, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
    recvcounts, rdispls, /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm);
  return ;
}
...
******************************************************/
int MPI_Ialltoallv_c(TAU_MPICH3_CONST void* sendbuf, TAU_MPICH3_CONST MPI_Count sendcounts[], TAU_MPICH3_CONST MPI_Aint sdispls[], MPI_Datatype sendtype,
void* recvbuf, TAU_MPICH3_CONST MPI_Count recvcounts[], TAU_MPICH3_CONST MPI_Aint rdispls[], MPI_Datatype recvtype,
MPI_Comm comm, MPI_Request* request)
{
  int retvalue;
  ...
  TAU_PROFILE_START(t);
  PMPI_Ialltoallv_c(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype,
    comm, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint comm, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Ialltoallv_c(sendbuf, sendcounts, sdispls, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
    recvcounts, rdispls, /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm, request);
  return ;
}
...
MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoallv_init(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
...
MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoallv_init(sendbuf, sendcounts, sdispls, /* MPI_HANDLE_TYPES */ sendtype, recvbuf,
    recvcounts, rdispls, /* MPI_HANDLE_TYPES */ recvtype, /* MPI_HANDLE_TYPES */ comm,
    /* MPI_HANDLE_TYPES */ info, request);
  return ;
}
...
MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoallv_init_c(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
    recvtype, comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint comm, MPI_Fint info, MPI_Request* request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoallv_init_c(sendbuf, sendcounts, sdispls, /* MPI_HANDLE_TYPES */ sendtype,
...
TAU_MPICH3_CONST MPI_Aint rdispls[], TAU_MPICH3_CONST MPI_Datatype recvtypes[], MPI_Comm comm)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes,
    comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
void MPI_ALLTOALLW_C(MPI_Aint sendbuf, MPI_Count sendcounts[], MPI_Aint sdispls[],
...
MPI_Aint rdispls[], MPI_Datatype recvtypes[], MPI_Fint comm, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Alltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
    recvtypes, /* MPI_HANDLE_TYPES */ comm);
  return ;
}
...
******************************************************/
void mpi_alltoallw_c_(MPI_Aint sendbuf, MPI_Count sendcounts[], MPI_Aint sdispls[],
MPI_Datatype sendtypes[], MPI_Aint recvbuf, MPI_Count recvcounts[],
MPI_Aint rdispls[], MPI_Datatype recvtypes[], MPI_Fint comm, MPI_Fint * ierr)
{
  MPI_ALLTOALLW_C(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes,
...
******************************************************/
void mpi_alltoallw_c__(MPI_Aint sendbuf, MPI_Count sendcounts[], MPI_Aint sdispls[],
MPI_Datatype sendtypes[], MPI_Aint recvbuf, MPI_Count recvcounts[],
MPI_Aint rdispls[], MPI_Datatype recvtypes[], MPI_Fint comm, MPI_Fint * ierr)
{
  MPI_ALLTOALLW_C(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes,
...
TAU_MPICH3_CONST MPI_Aint rdispls[], TAU_MPICH3_CONST MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Ialltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Ialltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
    recvtypes, /* MPI_HANDLE_TYPES */ comm, request);
  return ;
}
...
MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoallw_init(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Alltoallw_init_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
    recvtypes, comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST char* stringtag, MPI_Info info, MPI_Errhandler errhandler, MPI_Comm* newintercomm)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Intercomm_create_from_groups(local_group, local_leader, remote_group, remote_leader,
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Isendrecv_c(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype,
...
MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Gather_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Gather_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Igatherv_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Gatherv_init(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Gatherv_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root,
    comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Aint target_disp, MPI_Count target_count, MPI_Datatype target_datatype, MPI_Win win)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Get_c(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count,
    target_datatype, win);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Rget_c(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count,
...
MPI_Count target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Get_accumulate_c(origin_addr, origin_count, origin_datatype, result_addr, result_count,
...
MPI_Count target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Rget_accumulate_c(origin_addr, origin_count, origin_datatype, result_addr, result_count,
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Ineighbor_allgather_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_allgather_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_allgather_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST MPI_Count recvcounts[], TAU_MPICH3_CONST MPI_Aint displs[], MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_allgatherv_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
    comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Ineighbor_allgatherv_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
    comm, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST int displs[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_allgatherv_init(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
    comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_allgatherv_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs,
    recvtype, comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Ineighbor_alltoall_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoall_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoall_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoallv_c(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
    recvtype, comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Ineighbor_alltoallv_c(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
...
MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoallv_init(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
    recvtype, comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoallv_init_c(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts,
...
TAU_MPICH3_CONST MPI_Aint rdispls[], TAU_MPICH3_CONST MPI_Datatype recvtypes[], MPI_Comm comm)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
    recvtypes, comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST MPI_Aint rdispls[], TAU_MPICH3_CONST MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Ineighbor_alltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
    recvtypes, comm, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoallw_init(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts,
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Neighbor_alltoallw_init_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts,
    rdispls, recvtypes, comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Scatter_init(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Scatter_init_c(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, info,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Iscatterv_c(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm,
    request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Scatterv_init(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root,
    comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Scatterv_init_c(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root,
    comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Precv_init(buf, partitions, count, datatype, source, tag, comm, info, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Aint target_disp, MPI_Count target_count, MPI_Datatype target_datatype, MPI_Win win)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Put_c(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count,
    target_datatype, win);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Rput_c(origin_addr, origin_count, origin_datatype, target_rank, target_disp, target_count,
    target_datatype, win, request);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datarep_extent_function* dtype_file_extent_fn, void* extra_state)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Register_datarep_c(datarep, read_conversion_fn, write_conversion_fn, dtype_file_extent_fn,
    extra_state);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Status* status)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Sendrecv_c(sendbuf, sendcount, sendtype, dest, sendtag, recvbuf, recvcount, recvtype, source,
    recvtag, comm, status);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
int MPI_Status_set_elements_c(MPI_Status* status, MPI_Datatype datatype, MPI_Count count)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Status_set_elements_c(status, datatype, count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype* newtype)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Type_create_darray_c(size, rank, ndims, array_of_gsizes, array_of_distribs, array_of_dargs,
...
TAU_MPICH3_CONST MPI_Datatype array_of_types[], MPI_Datatype* newtype)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Type_create_struct_c(count, array_of_blocklengths, array_of_displacements, array_of_types,
    newtype);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST MPI_Count array_of_starts[], int order, MPI_Datatype oldtype, MPI_Datatype* newtype)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Type_create_subarray_c(ndims, array_of_sizes, array_of_subsizes, array_of_starts, order,
    oldtype, newtype);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Count array_of_large_counts[], MPI_Datatype array_of_datatypes[])
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Type_get_contents_c(datatype, max_integers, max_addresses, max_large_counts, max_datatypes,
...
MPI_Count* num_large_counts, MPI_Count* num_datatypes, int* combiner)
{
  ...
  TAU_PROFILE_START(t);
  PMPI_Type_get_envelope_c(datatype, num_integers, num_addresses, num_large_counts, num_datatypes,
    combiner);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
