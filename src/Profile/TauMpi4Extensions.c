...
//In the case of _init, we may need to track the request
// if we want to identify which *_init function is used with
// MPI_Start and MPI_Wait.
...
static MPI_Count sum_array_count (TAU_MPICH3_CONST MPI_Count *counts, MPI_Datatype type, MPI_Comm comm) {
...
static MPI_Count sum_array_w_count (TAU_MPICH3_CONST MPI_Count *counts, TAU_MPICH3_CONST  MPI_Datatype *type, MPI_Comm comm) {
...
int recvcount, MPI_Datatype recvtype, int source, int recvtag, MPI_Comm comm, MPI_Request* request)
{
  ...
  if (recvtype != MPI_DATATYPE_NULL) {
      PMPI_Type_size( recvtype, &typesize1 );
  }
  TAU_ISENDRECV_DATA((typesize*sendcount)+(typesize1*recvcount));
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Comm comm, MPI_Request * request)
{
  ...
  TAU_ISENDRECV_REP_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
void MPI_INFO_GET_STRING(MPI_Fint * info, char * key, MPI_Fint * buflen, char * value, MPI_Fint * flag, MPI_Fint * ierr, int len_key, int len_val)
{
  TAU_MPICH3_CONST char * local_key = (TAU_MPICH3_CONST char *)trim_fortran_string(key, len_key);

  char local_value[len_val];
  memset(local_value, ' ', len_val);

  *ierr = MPI_Info_get_string( MPI_Info_f2c(*info), local_key, buflen, local_value, flag);
  //Copy the local value back to the original variable, needed with C to Fortran
  if (*flag) {
    memcpy(value, local_value, len_val);
  } else {
      memset(value, ' ', len_val);
  }
...
void mpi_info_get_string(MPI_Fint * info, char * key, MPI_Fint * buflen, char * value, MPI_Fint * flag, MPI_Fint * ierr, int len_key, int len_val)
{
  MPI_INFO_GET_STRING(info, key, buflen, value, flag, ierr, len_key, len_val);
}

/******************************************************
***      MPI_Info_get_string wrapper function (lowercase_)
******************************************************/
void mpi_info_get_string_(MPI_Fint * info, char * key, MPI_Fint * buflen, char * value, MPI_Fint * flag, MPI_Fint * ierr, int len_key, int len_val)
{
  MPI_INFO_GET_STRING(info, key, buflen, value, flag, ierr, len_key, len_val);
}
...
******************************************************/
void mpi_info_get_string__(MPI_Fint * info, char * key, MPI_Fint * buflen, char * value, MPI_Fint * flag, MPI_Fint * ierr, int len_key, int len_val)
{
  MPI_INFO_GET_STRING(info, key, buflen, value, flag, ierr, len_key, len_val);
}
...
***      MPI_Info_create_env wrapper function (lowercase_)
******************************************************/
void mpi_info_create_env_f08_(MPI_Fint * argc, char **argv, MPI_Info * info, MPI_Fint * ierr)
{
  MPI_INFO_CREATE_ENV(argc, argv, info, ierr);
}
...
MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  TAU_ALLGATHERC_DATA(typesize*recvcount);

  TIMER_EXIT_COLLECTIVE_EXCH_ALL_EVENT("MPI_Allgather_c",typesize*sendcount,typesize*recvcount,0,comm);
  TAU_PROFILE_STOP(t);
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_IALLGATHERC_DATA(typesize*recvcount);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
TAU_MPICH3_CONST MPI_Count *recvcounts, TAU_MPICH3_CONST MPI_Aint *displs, MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  track_allvector(TAU_ALLGATHERVC_DATA, recvcounts, typesize);
...
MPI_Request* request)
{
  ...
  track_allvector(TAU_IALLGATHERVC_DATA, recvcounts, typesize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_ALLGATHERV_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
...
******************************************************/
void mpi_allgatherv_init(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
int * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_allgatherv_init_(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
int * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ALLGATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, info, request, ierr);
}
...
******************************************************/
void mpi_allgatherv_init__(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
int * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ALLGATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, comm, info, request, ierr);
}
...
******************************************************/
extern void MPI_ALLGATHERV_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
...
int MPI_Allreduce_c(TAU_MPICH3_CONST void* sendbuf, void* recvbuf, MPI_Count count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm)
{
  ...
  TAU_ALLREDUCEC_DATA(typesize*count);
  TIMER_EXIT_COLLECTIVE_EXCH_EVENT("MPI_Allreduce_c",typesize*count,0,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Request* request)
{
  ...
  TAU_IALLREDUCEC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  TAU_ALLTOALLC_DATA((typesize*recvcount)+(typesize2*sendcount));

  TIMER_EXIT_COLLECTIVE_EXCH_ALL_EVENT("MPI_Alltoall_c",typesize*sendcount,typesize*recvcount,0,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_IALLTOALLC_DATA((typesize*recvcount)+(typesize2*sendcount));
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  tracksize = sum_array_count(sendcounts, sendtype, comm);
  tracksize += sum_array_count(recvcounts, recvtype, comm);
  TAU_ALLTOALLVC_DATA(tracksize);
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  tracksize = sum_array_count(sendcounts, sendtype, comm);
  tracksize += sum_array_count(recvcounts, recvtype, comm);
  TAU_IALLTOALLVC_DATA(tracksize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_ALLTOALLV_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Alltoallv_init wrapper function (lowercase)
******************************************************/
void mpi_alltoallv_init(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_alltoallv_init_(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ALLTOALLV_INIT(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype,
    comm, info, request, ierr);
...
******************************************************/
void mpi_alltoallv_init__(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ALLTOALLV_INIT(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls, recvtype,
    comm, info, request, ierr);
...
TAU_MPICH3_CONST MPI_Aint * rdispls, TAU_MPICH3_CONST MPI_Datatype * recvtypes, MPI_Comm comm)
{
  ...
  retvalue = PMPI_Alltoallw_c(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes,
    comm);
  tracksize =  sum_array_w_count(sendcounts, sendtypes, comm);
  tracksize += sum_array_w_count(recvcounts, recvtypes, comm);
  TAU_ALLTOALLWC_DATA(tracksize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_ALLTOALLW_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf, 
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * ierr);

/******************************************************
***      MPI_Alltoallw_c wrapper function (lowercase)
******************************************************/
void mpi_alltoallw_c(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf, 
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_alltoallw_c_(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf, 
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_ALLTOALLW_C(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes,
    comm, ierr);
...
******************************************************/
void mpi_alltoallw_c__(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf, 
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_ALLTOALLW_C(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls, recvtypes,
    comm, ierr);
...
TAU_MPICH3_CONST MPI_Aint * rdispls, TAU_MPICH3_CONST MPI_Datatype * recvtypes, MPI_Comm comm, MPI_Request* request)
{
  ...
  tracksize =  sum_array_w_count(sendcounts, sendtypes, comm);
  tracksize += sum_array_w_count(recvcounts, recvtypes, comm);
  TAU_IALLTOALLWC_DATA(tracksize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Fint * sendtypes, MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Aint * rdispls, 
MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_ALLTOALLW_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Alltoallw_init wrapper function (lowercase)
******************************************************/
void mpi_alltoallw_init(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_alltoallw_init_(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ALLTOALLW_INIT(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
...
******************************************************/
void mpi_alltoallw_init__(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ALLTOALLW_INIT(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
...
MPI_Fint * sendtypes, MPI_Aint * recvbuf, MPI_Count * recvcounts,
...
int MPI_Bcast_c(void* buffer, MPI_Count count, MPI_Datatype datatype, int root, MPI_Comm comm)
{
  ...
  TAU_BCASTC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_BCAST_C(MPI_Aint * buffer, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * ierr);
...
int MPI_Ibcast_c(void* buffer, MPI_Count count, MPI_Datatype datatype, int root, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_IBCASTC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_IBCAST_C(MPI_Aint * buffer, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * root, MPI_Fint * comm,
MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_BCAST_INIT(MPI_Aint * buffer, MPI_Fint * count, MPI_Fint * datatype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info,
MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_BCAST_INIT_C(MPI_Aint * buffer, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info,
MPI_Request * request, MPI_Fint * ierr);
/******************************************************
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Bsend_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm));
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Bsend_init_c(buf, *count, MPI_Type_f2c(*datatype), *dest,
    *tag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
******************************************************/
extern void MPI_EXSCAN_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Fint * ierr);
...
******************************************************/
extern void MPI_IEXSCAN_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_EXSCAN_INIT(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_EXSCAN_INIT_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
/******************************************************
...
void MPI_FILE_IREAD_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_File local_fh; 
  MPI_Request local_request;
  *ierr = MPI_File_iread_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_request) ; 
...
void MPI_FILE_IREAD_ALL_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_File local_fh; 
  MPI_Request local_request;
  *ierr = MPI_File_iread_all_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_request) ; 
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Request * request, MPI_Fint * ierr)
{
  MPI_File local_fh; 
  MPI_Request local_request;
  *ierr = MPI_File_iread_at_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_request) ; 
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Fint * ierr, int str_len)
{
  MPI_Comm local_newcomm;
  MPI_Errhandler local_errhandler; 
  TAU_MPICH3_CONST char * local_stringtag = (TAU_MPICH3_CONST char *)trim_fortran_string(stringtag, str_len);
  *ierr = MPI_Comm_create_from_group( MPI_Group_f2c(*group), local_stringtag, MPI_Info_f2c(*info), MPI_Errhandler_f2c(*errhandler), &local_newcomm);
  free((void*)local_stringtag);
  *newcomm = MPI_Comm_c2f(local_newcomm);
}
...
MPI_Fint * ierr, int str_len)
{
  MPI_COMM_CREATE_FROM_GROUP(group, stringtag, info, errhandler, newcomm, ierr, str_len);
}
...
******************************************************/
void MPI_GROUP_FROM_SESSION_PSET(MPI_Fint * session, char * pset_name, MPI_Group * newgroup, MPI_Fint * ierr, int str_len)
{
  MPI_Group local_newgroup;
  TAU_MPICH3_CONST char * local_pset_name = (TAU_MPICH3_CONST char *)trim_fortran_string(pset_name, str_len);
  *ierr = MPI_Group_from_session_pset( MPI_Session_f2c(*session), local_pset_name, &local_newgroup);
  free((void*)local_pset_name);
  *newgroup = MPI_Group_c2f(local_newgroup);
}
...
void mpi_group_from_session_pset(MPI_Fint * session, char * pset_name, MPI_Group * newgroup, MPI_Fint * ierr, int str_len)
{
  MPI_GROUP_FROM_SESSION_PSET(session, pset_name, newgroup, ierr, str_len);
}

/******************************************************
***      MPI_Group_from_session_pset wrapper function (lowercase_)
******************************************************/
void mpi_group_from_session_pset_(MPI_Fint * session, char * pset_name, MPI_Group * newgroup, MPI_Fint * ierr, int str_len)
{
  MPI_GROUP_FROM_SESSION_PSET(session, pset_name, newgroup, ierr, str_len);
}
...
******************************************************/
void mpi_group_from_session_pset__(MPI_Fint * session, char * pset_name, MPI_Group * newgroup, MPI_Fint * ierr, int str_len)
{
  MPI_GROUP_FROM_SESSION_PSET(session, pset_name, newgroup, ierr, str_len);
}
...
char * stringtag, MPI_Fint * info, MPI_Fint * errhandler, MPI_Comm * newintercomm, MPI_Fint * ierr, int st_len)
{
  MPI_Comm local_newintercomm;
  MPI_Errhandler local_errhandler;
  TAU_MPICH3_CONST char * local_stringtag = (TAU_MPICH3_CONST char *)trim_fortran_string(stringtag, st_len);
  *ierr = MPI_Intercomm_create_from_groups( MPI_Group_f2c(*local_group), *local_leader, MPI_Group_f2c(*remote_group),
    *remote_leader, local_stringtag, MPI_Info_f2c(*info), local_errhandler, &local_newintercomm);
  free((void*)local_stringtag);
  *errhandler = (MPI_Errhandler)(intptr_t)(MPI_Errhandler_c2f(local_errhandler));
  *newintercomm = MPI_Comm_c2f(local_newintercomm);
}
...
char * stringtag, MPI_Fint * info, MPI_Fint * errhandler, MPI_Comm * newintercomm, MPI_Fint * ierr, int st_len)
{
  MPI_INTERCOMM_CREATE_FROM_GROUPS(local_group, local_leader, remote_group, remote_leader,
    stringtag, info, errhandler, newintercomm, ierr, st_len);
}
...
MPI_Request* request)
{
  ...
  TAU_ISENDRECVC_DATA((typesize*sendcount)+(typesize1*recvcount));
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Isendrecv_c(sendbuf, *sendcount, MPI_Type_f2c(*sendtype),
    *dest, *sendtag, recvbuf, *recvcount, MPI_Type_f2c(*recvtype), *source, *recvtag,
...
{
  MPI_Request local_request;
  *ierr = MPI_Isendrecv_replace_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *sendtag, *source,
    *recvtag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Request * request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_File_iread_at_all_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
void MPI_FILE_IREAD_SHARED_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Request * request, MPI_Fint * ierr)
{
  ...
  MPI_Request local_request;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_iread_shared_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
void MPI_FILE_IWRITE_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Request * request, MPI_Fint * ierr)
{
  ...
  MPI_Request local_request;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_iwrite_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
void MPI_FILE_IWRITE_ALL_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Request * request, MPI_Fint * ierr)
{
  ...
  MPI_Request local_request;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_iwrite_all_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Request * request, MPI_Fint * ierr)
{
  ...
  MPI_Request local_request;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_iwrite_at_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Request * request, MPI_Fint * ierr)
{
  ...
  MPI_Request local_request;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_iwrite_at_all_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
void MPI_FILE_IWRITE_SHARED_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Request * request, MPI_Fint * ierr)
{
  ...
  MPI_Request local_request;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_iwrite_shared_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_request);
  *fh = MPI_File_c2f(local_fh);
  *request = MPI_Request_c2f(local_request);
}
...
******************************************************/
void MPI_FILE_READ_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
...
******************************************************/
void mpi_file_read_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_read_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void MPI_FILE_READ_ALL_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_all_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_read_all_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_ALL_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_read_all_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_ALL_C(fh, buf, count, datatype, status, ierr);
}
...
void MPI_FILE_READ_ALL_BEGIN_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_all_begin_c( local_fh, buf, *count, MPI_Type_f2c(*datatype));
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void MPI_FILE_READ_AT_C(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  MPI_Status local_status; 
  *ierr = MPI_File_read_at_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_read_at_c_(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_READ_AT_C(fh, offset, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_read_at_c__(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_READ_AT_C(fh, offset, buf, count, datatype, status, ierr);
}
...
******************************************************/
void MPI_FILE_READ_AT_ALL_C(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  MPI_Status local_status;
  *ierr = MPI_File_read_at_all_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_read_at_all_c_(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_READ_AT_ALL_C(fh, offset, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_read_at_all_c__(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_READ_AT_ALL_C(fh, offset, buf, count, datatype, status, ierr);
}
...
void MPI_FILE_READ_AT_ALL_BEGIN_C(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_at_all_begin_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype));
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void MPI_FILE_READ_ORDERED_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_ordered_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_read_ordered_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_ORDERED_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_read_ordered_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_ORDERED_C(fh, buf, count, datatype, status, ierr);
}
...
void MPI_FILE_READ_ORDERED_BEGIN_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_ordered_begin_c( local_fh, buf, *count, MPI_Type_f2c(*datatype));
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void MPI_FILE_READ_SHARED_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_read_shared_c( local_fh, buf, *count, MPI_Type_f2c(*datatype),  &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_read_shared_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_SHARED_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_read_shared_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_READ_SHARED_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void MPI_FILE_WRITE_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_c( local_fh, buf, *count, MPI_Type_f2c(*datatype),  &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_write_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_write_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void MPI_FILE_WRITE_ALL_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_all_c( local_fh, buf, *count, MPI_Type_f2c(*datatype),  &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_write_all_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_ALL_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_write_all_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_ALL_C(fh, buf, count, datatype, status, ierr);
}
...
void MPI_FILE_WRITE_ALL_BEGIN_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_all_begin_c( local_fh, buf, *count, MPI_Type_f2c(*datatype));
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void MPI_FILE_WRITE_AT_C(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_at_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_write_at_c_(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_WRITE_AT_C(fh, offset, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_write_at_c__(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_WRITE_AT_C(fh, offset, buf, count, datatype, status, ierr);
}
...
******************************************************/
void MPI_FILE_WRITE_AT_ALL_C(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status; 
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_at_all_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_write_at_all_c_(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_WRITE_AT_ALL_C(fh, offset, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_write_at_all_c__(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status,
MPI_Fint * ierr)
{
  MPI_FILE_WRITE_AT_ALL_C(fh, offset, buf, count, datatype, status, ierr);
}
...
void MPI_FILE_WRITE_AT_ALL_BEGIN_C(MPI_Fint * fh, MPI_Offset * offset, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_at_all_begin_c( local_fh, *offset, buf, *count, MPI_Type_f2c(*datatype));
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void MPI_FILE_WRITE_ORDERED_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_ordered_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_write_ordered_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_ORDERED_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_write_ordered_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_ORDERED_C(fh, buf, count, datatype, status, ierr);
}
...
void MPI_FILE_WRITE_ORDERED_BEGIN_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * ierr)
{
  MPI_File local_fh;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_ordered_begin_c( local_fh, buf, *count, MPI_Type_f2c(*datatype));
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void MPI_FILE_WRITE_SHARED_C(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_File local_fh;
  MPI_Status local_status;
  local_fh = MPI_File_f2c(*fh);
  *ierr = MPI_File_write_shared_c( local_fh, buf, *count, MPI_Type_f2c(*datatype), &local_status) ; 
  MPI_Status_c2f(&local_status, status);
  *fh = MPI_File_c2f(local_fh);
}
...
******************************************************/
void mpi_file_write_shared_c_(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_SHARED_C(fh, buf, count, datatype, status, ierr);
}
...
******************************************************/
void mpi_file_write_shared_c__(MPI_Fint * fh, MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_FILE_WRITE_SHARED_C(fh, buf, count, datatype, status, ierr);
}
...
MPI_Datatype recvtype, int root, MPI_Comm comm)
{
  ...
  if (rank == root) {
    TAU_GATHERC_DATA(typesize*recvcount);
  }

  TIMER_EXIT_COLLECTIVE_EXCH_ALL_EVENT("MPI_Gather_c",typesize*sendcount,typesize*recvcount,root,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request* request)
{
  ...
  if (rank == root) {
    TAU_IGATHERC_DATA(typesize*recvcount);
  }
  TIMER_EXIT_COLLECTIVE_EXCH_ALL_EVENT("MPI_Igather_c",typesize*sendcount,typesize*recvcount,root,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_IGATHER_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
...
******************************************************/
extern void MPI_GATHER_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcount,
MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_GATHER_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
MPI_Comm comm)
{
  ...
  track_vector(TAU_GATHERVC_DATA, recvcounts, recvtype);
...
******************************************************/
extern void MPI_GATHERV_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * displs, MPI_Fint * recvtype, MPI_Fint *  root, MPI_Fint * comm, MPI_Fint * ierr);
/******************************************************
...
MPI_Comm comm, MPI_Request* request)
{
  ...
  retvalue = PMPI_Igatherv_c(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm,
    request);
  track_vector(TAU_IGATHERVC_DATA, recvcounts, recvtype);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_IGATHERV_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
...
TAU_MPICH3_CONST int *displs, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  int retvalue;
...
******************************************************/
extern void MPI_GATHERV_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
/******************************************************
***      MPI_Gatherv_init wrapper function (lowercase)
******************************************************/
void mpi_gatherv_init(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_gatherv_init_(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_GATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm,
    info, request, ierr);
...
******************************************************/
void mpi_gatherv_init__(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_GATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype, root, comm,
    info, request, ierr);
...
******************************************************/
extern void MPI_GATHERV_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * displs, MPI_Fint * recvtype, MPI_Fint * root,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
MPI_Aint * target_disp, MPI_Count * target_count, MPI_Fint * target_datatype, MPI_Fint * win, MPI_Fint * ierr)
{

  *ierr = MPI_Get_c(origin_addr, *origin_count, MPI_Type_f2c(*origin_datatype),
    *target_rank, *target_disp, *target_count, MPI_Type_f2c(*target_datatype), MPI_Win_f2c(*win));
}
...
MPI_Aint * target_disp, MPI_Count * target_count, MPI_Fint * target_datatype, MPI_Fint * win, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_Request local_request;
  *ierr = MPI_Rget_c(origin_addr, *origin_count, MPI_Type_f2c(*origin_datatype),
    *target_rank, *target_disp, *target_count, MPI_Type_f2c(*target_datatype), MPI_Win_f2c(*win), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Count * target_count, MPI_Fint * target_datatype, MPI_Fint * op, MPI_Fint * win, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Get_accumulate_c(origin_addr, *origin_count, MPI_Type_f2c(*origin_datatype),
    result_addr, *result_count, MPI_Type_f2c(*result_datatype), *target_rank, *target_disp, *target_count,
    MPI_Type_f2c(*target_datatype), MPI_Op_f2c(*op), MPI_Win_f2c(*win));
}
...
MPI_Count * result_count, MPI_Fint * result_datatype, MPI_Fint * target_rank, MPI_Aint * target_disp,
MPI_Count * target_count, MPI_Fint * target_datatype, MPI_Fint * op, MPI_Fint * win, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_Request local_request;
  *ierr = MPI_Rget_accumulate_c(origin_addr, *origin_count, MPI_Type_f2c(*origin_datatype),
    result_addr, *result_count, MPI_Type_f2c(*result_datatype), *target_rank, *target_disp, 
...
******************************************************/
void MPI_GET_COUNT_C(MPI_Fint * status, MPI_Fint * datatype, MPI_Count * count, MPI_Fint * ierr)
{
  MPI_Status local_status;
  MPI_Status_f2c(status, &local_status);
  *ierr = MPI_Get_count_c(&local_status, MPI_Type_f2c(*datatype), count);
}
...
******************************************************/
void mpi_get_count_c_(MPI_Fint * status, MPI_Fint * datatype, MPI_Count * count, MPI_Fint * ierr)
{
  MPI_GET_COUNT_C(status, datatype, count, ierr);
}
...
******************************************************/
void mpi_get_count_c__(MPI_Fint * status, MPI_Fint * datatype, MPI_Count * count, MPI_Fint * ierr)
{
  MPI_GET_COUNT_C(status, datatype, count, ierr);
}
...
******************************************************/
void MPI_GET_ELEMENTS_C(MPI_Fint* status, MPI_Fint * datatype, MPI_Count* count, MPI_Fint * ierr)
{
  MPI_Status local_status;
  MPI_Status_f2c(status, &local_status);
  *ierr = MPI_Get_elements_c(&local_status, MPI_Type_f2c(*datatype), count);
}
...
******************************************************/
void mpi_get_elements_c_(MPI_Fint* status, MPI_Fint * datatype, MPI_Count* count, MPI_Fint * ierr)
{
  MPI_GET_ELEMENTS_C(status, datatype, count, ierr);
}
...
******************************************************/
void mpi_get_elements_c__(MPI_Fint* status, MPI_Fint * datatype, MPI_Count* count, MPI_Fint * ierr)
{
  MPI_GET_ELEMENTS_C(status, datatype, count, ierr);
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Ibsend_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Imrecv_c(buf, *count, MPI_Type_f2c(*datatype), &local_message, &local_request);
...
MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  TAU_NALLGATHERC_DATA(typesize*recvcount);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_NEIGHBOR_ALLGATHER_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * ierr);
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_INALLGATHERC_DATA(typesize*recvcount);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_INEIGHBOR_ALLGATHER_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLGATHER_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
TAU_MPICH3_CONST MPI_Count *recvcounts, TAU_MPICH3_CONST MPI_Aint *displs, MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  track_allvector(TAU_NALLGATHERVC_DATA, recvcounts, typesize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_NEIGHBOR_ALLGATHERV_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * ierr);
...
MPI_Request* request)
{
  ...
  track_allvector(TAU_INALLGATHERVC_DATA, recvcounts, typesize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_INEIGHBOR_ALLGATHERV_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLGATHERV_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Neighbor_allgatherv_init wrapper function (lowercase)
******************************************************/
void mpi_neighbor_allgatherv_init(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_neighbor_allgatherv_init_(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLGATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
    comm, info, request, ierr);
...
******************************************************/
void mpi_neighbor_allgatherv_init__(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcounts,
MPI_Fint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLGATHERV_INIT(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs, recvtype,
    comm, info, request, ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLGATHERV_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * displs, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
MPI_Datatype recvtype, MPI_Comm comm)
{
  ...
  TAU_NALLTOALLC_DATA((typesize*recvcount)+(typesize2*sendcount));
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALL_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * ierr);
...
MPI_Datatype recvtype, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_INALLTOALLC_DATA((typesize*recvcount)+(typesize2*sendcount));
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_INEIGHBOR_ALLTOALL_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Ineighbor_alltoall_c wrapper function (lowercase)
******************************************************/
void mpi_ineighbor_alltoall_c(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_ineighbor_alltoall_c_(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_INEIGHBOR_ALLTOALL_C(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    request, ierr);
...
******************************************************/
void mpi_ineighbor_alltoall_c__(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_INEIGHBOR_ALLTOALL_C(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm,
    request, ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALL_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcount,
MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALL_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
void* recvbuf, TAU_MPICH3_CONST MPI_Count *recvcounts, TAU_MPICH3_CONST MPI_Aint *rdispls, MPI_Datatype recvtype, MPI_Comm comm)
{
  int retvalue;
  MPI_Count tracksize = 0;
  ...
  tracksize = sum_array_count(sendcounts, sendtype, comm);
  tracksize += sum_array_count(recvcounts, recvtype, comm);
  TAU_NALLTOALLVC_DATA(tracksize);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALLV_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtype,
MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * ierr);
...
******************************************************/
int MPI_Ineighbor_alltoallv_c(TAU_MPICH3_CONST void* sendbuf, TAU_MPICH3_CONST MPI_Count *sendcounts, TAU_MPICH3_CONST MPI_Aint *sdispls, 
MPI_Datatype sendtype, void* recvbuf, TAU_MPICH3_CONST MPI_Count *recvcounts, TAU_MPICH3_CONST MPI_Aint *rdispls, MPI_Datatype recvtype,
MPI_Comm comm, MPI_Request* request)
{
  int retvalue;
  MPI_Count tracksize = 0;
  ...
  tracksize = sum_array_count(sendcounts, sendtype, comm);
  tracksize += sum_array_count(recvcounts, recvtype, comm);
  TAU_INALLTOALLVC_DATA(tracksize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_INEIGHBOR_ALLTOALLV_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtype,
MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtype,
MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
int MPI_Neighbor_alltoallv_init(TAU_MPICH3_CONST void* sendbuf, TAU_MPICH3_CONST int *sendcounts, TAU_MPICH3_CONST int *sdispls, 
MPI_Datatype sendtype, void* recvbuf, TAU_MPICH3_CONST int *recvcounts, TAU_MPICH3_CONST int *rdispls, MPI_Datatype recvtype, 
MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  int retvalue;
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALLV_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Neighbor_alltoallv_init wrapper function (lowercase)
******************************************************/
void mpi_neighbor_alltoallv_init(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_neighbor_alltoallv_init_(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLTOALLV_INIT(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
    recvtype, comm, info, request, ierr);
...
******************************************************/
void mpi_neighbor_alltoallv_init__(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * sdispls, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcounts, MPI_Fint * rdispls, MPI_Fint * recvtype, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLTOALLV_INIT(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts, rdispls,
    recvtype, comm, info, request, ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALLV_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtype,
MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtype,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
TAU_MPICH3_CONST MPI_Aint *rdispls, TAU_MPICH3_CONST MPI_Datatype *recvtypes, MPI_Comm comm)
{
  ...
  tracksize =  sum_array_w_count(sendcounts, sendtypes, comm);
  tracksize += sum_array_w_count(recvcounts, recvtypes, comm);
  TAU_NALLTOALLWC_DATA(tracksize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALLW_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls,
MPI_Fint * sendtypes, MPI_Aint * recvbuf, MPI_Count * recvcounts,
...
TAU_MPICH3_CONST MPI_Aint *rdispls, TAU_MPICH3_CONST MPI_Datatype *recvtypes, MPI_Comm comm, MPI_Request* request)
{
  ...
  tracksize =  sum_array_w_count(sendcounts, sendtypes, comm);
  tracksize += sum_array_w_count(recvcounts, recvtypes, comm);
  TAU_INALLTOALLWC_DATA(tracksize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_INEIGHBOR_ALLTOALLW_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls,
MPI_Fint * sendtypes, MPI_Aint * recvbuf, MPI_Count * recvcounts,
MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALLW_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes,
...
******************************************************/
void mpi_neighbor_alltoallw_init(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_neighbor_alltoallw_init_(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLTOALLW_INIT(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
...
******************************************************/
void mpi_neighbor_alltoallw_init__(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes,
MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLTOALLW_INIT(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts, rdispls,
...
TAU_MPICH3_CONST MPI_Datatype *sendtypes, void* recvbuf, TAU_MPICH3_CONST MPI_Count *recvcounts,
TAU_MPICH3_CONST MPI_Aint *rdispls, TAU_MPICH3_CONST MPI_Datatype *recvtypes, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  int retvalue;
...
******************************************************/
extern void MPI_NEIGHBOR_ALLTOALLW_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Neighbor_alltoallw_init_c wrapper function (lowercase)
******************************************************/
void mpi_neighbor_alltoallw_init_c(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_neighbor_alltoallw_init_c_(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLTOALLW_INIT_C(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts,
    rdispls, recvtypes, comm, info, request, ierr);
...
******************************************************/
void mpi_neighbor_alltoallw_init_c__(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * sdispls, MPI_Fint * sendtypes, MPI_Aint * recvbuf,
MPI_Count * recvcounts, MPI_Aint * rdispls, MPI_Fint * recvtypes, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_NEIGHBOR_ALLTOALLW_INIT_C(sendbuf, sendcounts, sdispls, sendtypes, recvbuf, recvcounts,
    rdispls, recvtypes, comm, info, request, ierr);
...
MPI_Request* request)
{
  ...
  TAU_IRECVC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Irecv_c(buf, *count, MPI_Type_f2c(*datatype), *source, *tag,  MPI_Comm_f2c(*comm), &local_request );
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Comm comm)
{
  ...
  TAU_REDUCEC_DATA(typesize*count);

  TIMER_EXIT_COLLECTIVE_EXCH_EVENT("MPI_Reduce_c",typesize*count,root,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_REDUCE_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * root,
...
MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_IREDUCEC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_IREDUCE_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * root,
MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_REDUCE_INIT(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * root,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_REDUCE_INIT_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * root,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
MPI_Comm comm)
{
  ...
  TAU_REDUCESCATTERC_DATA(typesize*(*recvcounts));

  TIMER_EXIT_COLLECTIVE_EXCH_EVENT("MPI_Reduce_scatter_c",typesize*(*recvcounts),0,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_REDUCE_SCATTER_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * ierr);
...
MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_IREDUCESCATTERC_DATA(typesize*(*recvcounts));
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_IREDUCE_SCATTER_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_REDUCE_SCATTER_INIT(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Reduce_scatter_init wrapper function (lowercase)
******************************************************/
void mpi_reduce_scatter_init(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_reduce_scatter_init_(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_REDUCE_SCATTER_INIT(sendbuf, recvbuf, recvcounts, datatype, op, comm, info, request, ierr);
}
...
******************************************************/
void mpi_reduce_scatter_init__(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_REDUCE_SCATTER_INIT(sendbuf, recvbuf, recvcounts, datatype, op, comm, info, request, ierr);
}
...
******************************************************/
extern void MPI_REDUCE_SCATTER_INIT_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * recvcounts, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
MPI_Comm comm)
{
  ...
  TAU_REDUCESCATTER_BLOCKC_DATA(typesize*recvcount);

  TIMER_EXIT_COLLECTIVE_EXCH_EVENT("MPI_Reduce_scatter_block_c",typesize*recvcount,0,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_REDUCE_SCATTER_BLOCK_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * recvcount, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * ierr);
...
MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_IREDUCESCATTER_BLOCKC_DATA(typesize*recvcount);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_IREDUCE_SCATTER_BLOCK_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * recvcount, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_REDUCE_SCATTER_BLOCK_INIT(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * recvcount, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_REDUCE_SCATTER_BLOCK_INIT_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * recvcount, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
{
  MPI_Request local_request;
  *ierr = MPI_Irsend_c(buf, *count,  MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
int MPI_Scan_c(TAU_MPICH3_CONST void* sendbuf, void* recvbuf, MPI_Count count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm)
{
  ...
  TAU_SCANC_DATA(typesize*count);

  TIMER_EXIT_COLLECTIVE_EXCH_EVENT("MPI_Scan_c",typesize*count,0,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_SCAN_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, 
MPI_Fint * comm, MPI_Fint * ierr);

/******************************************************
***      MPI_Scan_c wrapper function (lowercase)
******************************************************/
void mpi_scan_c(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_scan_c_(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_SCAN_C(sendbuf, recvbuf, count, datatype, op, comm, ierr);
}
...
******************************************************/
void mpi_scan_c__(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op,
MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_SCAN_C(sendbuf, recvbuf, count, datatype, op, comm, ierr);
}
...
MPI_Request* request)
{
  ...
  TAU_ISCANC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_ISCAN_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_SCAN_INIT(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Fint * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_SCAN_INIT_C(MPI_Aint * sendbuf, MPI_Aint * recvbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * comm,
MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
MPI_Datatype recvtype, int root, MPI_Comm comm)
{
  ...
  TAU_SCATTERC_DATA(typesize*sendcount);

  TIMER_EXIT_COLLECTIVE_EXCH_ALL_EVENT("MPI_Scatter_c",typesize*sendcount,typesize*recvcnt,root,comm);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_SCATTER_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * ierr);
...
MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request* request)
{
  ...
  TAU_ISCATTERC_DATA(typesize*sendcount);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_ISCATTER_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_SCATTER_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Fint * recvcount,
MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);
...
******************************************************/
extern void MPI_SCATTER_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcount, MPI_Fint * sendtype, MPI_Aint * recvbuf, MPI_Count * recvcount,
MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request* request, MPI_Fint * ierr);
...
void* recvbuf, MPI_Count recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm)
{
  ...
  track_vector(TAU_SCATTERVC_DATA, sendcounts, typesize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_SCATTERV_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype,
MPI_Aint * recvbuf, MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * ierr);
...
void* recvbuf, MPI_Count recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request* request)
{
  ...
  retvalue = PMPI_Iscatterv_c(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm,
    request);
  track_vector(TAU_ISCATTERVC_DATA, sendcounts, typesize);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
extern void MPI_ISCATTERV_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Iscatterv_c wrapper function (lowercase)
******************************************************/
void mpi_iscatterv_c(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_iscatterv_c_(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ISCATTERV_C(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm,
    request, ierr);
...
******************************************************/
void mpi_iscatterv_c__(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_ISCATTERV_C(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm,
    request, ierr);
...
void* recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Info info, MPI_Request* request)
{
  int retvalue;
...
******************************************************/
extern void MPI_SCATTERV_INIT(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Scatterv_init wrapper function (lowercase)
******************************************************/
void mpi_scatterv_init(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_scatterv_init_(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_SCATTERV_INIT(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm,
    info, request, ierr);
...
******************************************************/
void mpi_scatterv_init__(MPI_Aint * sendbuf, MPI_Fint * sendcounts, MPI_Fint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf,
MPI_Fint * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_SCATTERV_INIT(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root, comm,
    info, request, ierr);
...
******************************************************/
extern void MPI_SCATTERV_INIT_C(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr);

/******************************************************
***      MPI_Scatterv_init_c wrapper function (lowercase)
******************************************************/
void mpi_scatterv_init_c(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
...
******************************************************/
void mpi_scatterv_init_c_(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_SCATTERV_INIT_C(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root,
    comm, info, request, ierr);
...
******************************************************/
void mpi_scatterv_init_c__(MPI_Aint * sendbuf, MPI_Count * sendcounts, MPI_Aint * displs, MPI_Fint * sendtype, MPI_Aint * recvbuf, 
MPI_Count * recvcount, MPI_Fint * recvtype, MPI_Fint * root, MPI_Fint * comm, MPI_Fint * info, MPI_Request * request, MPI_Fint * ierr)
{
  MPI_SCATTERV_INIT_C(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount, recvtype, root,
    comm, info, request, ierr);
...
MPI_Request* request)
{
  ...
  TAU_ISENDC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Isend_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request );
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Request* request)
{
  ...
  TAU_ISSENDC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Issend_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request );
  *request = MPI_Request_c2f(local_request);
}
...
******************************************************/
void MPI_MRECV_C(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Message * message, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_Status local_status; 
  MPI_Message local_message;
  local_message = MPI_Message_f2c(*message);
  *ierr = MPI_Mrecv_c(buf, *count, MPI_Type_f2c(*datatype), &local_message, &local_status);
  MPI_Status_c2f(&local_status, status);
  *message = MPI_Message_c2f(local_message);
}
...
******************************************************/
void mpi_mrecv_c_(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Message * message, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_MRECV_C(buf, count, datatype, message, status, ierr);
}
...
******************************************************/
void mpi_mrecv_c__(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Message * message, MPI_Fint * status, MPI_Fint * ierr)
{
  MPI_MRECV_C(buf, count, datatype, message, status, ierr);
}
...
{
  MPI_Op local_op; 
  *ierr = MPI_Op_create_c(user_fn, *commute, &local_op );
...
MPI_Count * position, MPI_Fint * comm, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Pack_c(inbuf, *incount, MPI_Type_f2c(*datatype), outbuf, *outsize, position, MPI_Comm_f2c(*comm));
}
...
MPI_Count * outsize, MPI_Count * position, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Pack_external_c(datarep, inbuf, *incount, MPI_Type_f2c(*datatype), outbuf, *outsize, position);
}
...
void MPI_PACK_EXTERNAL_SIZE_C(char * datarep, MPI_Count * incount, MPI_Fint * datatype, MPI_Count * size, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Pack_external_size_c(datarep, *incount, MPI_Type_f2c(*datatype), size);
}
...
void MPI_PACK_SIZE_C(MPI_Count * incount, MPI_Fint * datatype, MPI_Fint * comm, MPI_Count * size, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Pack_size_c( *incount, MPI_Type_f2c(*datatype), MPI_Comm_f2c(*comm), size);
}
...
void MPI_PARRIVED(MPI_Fint * request, MPI_Fint * partition, int * flag, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Parrived( MPI_Request_f2c(*request), *partition, flag);
}
...
void MPI_PREADY(MPI_Fint * partition, MPI_Fint * request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Pready( *partition, MPI_Request_f2c(*request));
}
...
******************************************************/
void MPI_PREADY_LIST(MPI_Fint * length, MPI_Fint * array_of_partitions, MPI_Fint * request, MPI_Fint * ierr)
{

  *ierr = MPI_Pready_list( *length, array_of_partitions, MPI_Request_f2c(*request));
}
...
******************************************************/
void mpi_pready_list_(MPI_Fint * length, MPI_Fint * array_of_partitions, MPI_Fint * request, MPI_Fint * ierr)
{
  MPI_PREADY_LIST(length, array_of_partitions, request, ierr);
}
...
******************************************************/
void mpi_pready_list__(MPI_Fint * length, MPI_Fint * array_of_partitions, MPI_Fint * request, MPI_Fint * ierr)
{
  MPI_PREADY_LIST(length, array_of_partitions, request, ierr);
}
...
void MPI_PREADY_RANGE(MPI_Fint * partition_low, MPI_Fint * partition_high, MPI_Fint * request, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Pready_range( *partition_low, *partition_high, MPI_Request_f2c(*request));
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Precv_init(buf, *partitions, *count,  MPI_Type_f2c(*datatype), *source, *tag,
    MPI_Comm_f2c(*comm), MPI_Info_f2c(*info), &local_request) ; 
  *request = MPI_Request_c2f(local_request);
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Psend_init(buf, *partitions, *count, MPI_Type_f2c(*datatype), *dest, *tag,
    MPI_Comm_f2c(*comm), MPI_Info_f2c(*info), &local_request) ; 
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Aint * target_disp, MPI_Count * target_count, MPI_Fint * target_datatype, MPI_Fint * win, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Put_c(origin_addr, *origin_count, MPI_Type_f2c(*origin_datatype), *target_rank, *target_disp, *target_count,
...
MPI_Aint target_disp, MPI_Count target_count, MPI_Datatype target_datatype, MPI_Win win, MPI_Request* request)
{
  int retvalue;
...
{
  MPI_Request local_request;
  *ierr = MPI_Rput_c(origin_addr, *origin_count, MPI_Type_f2c(*origin_datatype), *target_rank, *target_disp, *target_count,
    MPI_Type_f2c(*target_datatype), MPI_Win_f2c(*win), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
{
  MPI_Status local_status;
  *ierr = MPI_Recv_c(buf, *count, MPI_Type_f2c(*datatype), *source, *tag, MPI_Comm_f2c(*comm), &local_status);
  MPI_Status_c2f(&local_status, status);
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Recv_init_c(buf, *count, MPI_Type_f2c(*datatype), *source, *tag, MPI_Comm_f2c(*comm), &local_request );
  *request = MPI_Request_c2f(local_request);
}
...
void MPI_REDUCE_LOCAL_C(MPI_Aint * inbuf, MPI_Aint * inoutbuf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * op, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Reduce_local_c(inbuf, inoutbuf, *count, MPI_Type_f2c(*datatype), MPI_Op_f2c(*op));
}
...
******************************************************/
void MPI_REGISTER_DATAREP_C(char * datarep, MPI_Datarep_conversion_function_c * read_conversion_fn, MPI_Datarep_conversion_function_c * write_conversion_fn,
MPI_Datarep_extent_function * dtype_file_extent_fn, MPI_Aint * extra_state, MPI_Fint * ierr, int dr_len)
{
  TAU_MPICH3_CONST char * local_datarep = (TAU_MPICH3_CONST char *)trim_fortran_string(datarep, dr_len);
  *ierr = MPI_Register_datarep_c(local_datarep, read_conversion_fn, write_conversion_fn,
    dtype_file_extent_fn, extra_state);
  free((void*)local_datarep);
}
...
MPI_Datarep_extent_function * dtype_file_extent_fn, MPI_Aint * extra_state, MPI_Fint * ierr, int dr_len)
{
  MPI_REGISTER_DATAREP_C(datarep, read_conversion_fn, write_conversion_fn, dtype_file_extent_fn,
    extra_state, ierr, dr_len);
}

/******************************************************
***      MPI_Register_datarep_c wrapper function (lowercase_)
******************************************************/
void mpi_register_datarep_c_(char * datarep, MPI_Datarep_conversion_function_c * read_conversion_fn, MPI_Datarep_conversion_function_c * write_conversion_fn,
MPI_Datarep_extent_function * dtype_file_extent_fn, MPI_Aint * extra_state, MPI_Fint * ierr, int dr_len)
{
  MPI_REGISTER_DATAREP_C(datarep, read_conversion_fn, write_conversion_fn, dtype_file_extent_fn,
    extra_state, ierr, dr_len);
...
******************************************************/
void mpi_register_datarep_c__(char * datarep, MPI_Datarep_conversion_function_c * read_conversion_fn, MPI_Datarep_conversion_function_c * write_conversion_fn,
MPI_Datarep_extent_function * dtype_file_extent_fn, MPI_Aint * extra_state, MPI_Fint * ierr, int dr_len)
{
  MPI_REGISTER_DATAREP_C(datarep, read_conversion_fn, write_conversion_fn, dtype_file_extent_fn,
    extra_state, ierr, dr_len);
...
******************************************************/
void MPI_RSEND_C(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{

  *ierr = MPI_Rsend_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm));
}
...
******************************************************/
void mpi_rsend_c_(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_RSEND_C(buf, count, datatype, dest, tag, comm, ierr);
}
...
******************************************************/
void mpi_rsend_c__(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_RSEND_C(buf, count, datatype, dest, tag, comm, ierr);
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Rsend_init_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
******************************************************/
void MPI_SEND_C(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{

  *ierr = MPI_Send_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm));
}
...
******************************************************/
void mpi_send_c_(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_SEND_C(buf, count, datatype, dest, tag, comm, ierr);
}
...
******************************************************/
void mpi_send_c__(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_SEND_C(buf, count, datatype, dest, tag, comm, ierr);
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Send_init_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
MPI_Status* status)
{
  ...
  TAU_SENDRECVC_DATA((typesize*sendcount)+(typesize1*recvcount));
...
{
  MPI_Status local_status; 
  *ierr = MPI_Sendrecv_c(sendbuf, *sendcount, MPI_Type_f2c(*sendtype), *dest, *sendtag, recvbuf, *recvcount,
    MPI_Type_f2c(*recvtype), *source, *recvtag, MPI_Comm_f2c(*comm), &local_status);
  MPI_Status_c2f(&local_status, status);
}
...
{
  MPI_Status local_status; 
  *ierr = MPI_Sendrecv_replace_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *sendtag, *source,
    *recvtag, MPI_Comm_f2c(*comm), &local_status);
  MPI_Status_c2f(&local_status, status);
}
...
void MPI_SESSION_CALL_ERRHANDLER(MPI_Fint * session, MPI_Fint * errorcode, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Session_call_errhandler(MPI_Session_f2c(*session), *errorcode);
}
...
{
  MPI_Errhandler local_errhandler; 
  *ierr = MPI_Session_create_errhandler(session_errhandler_fn, &local_errhandler);
  *errhandler = (MPI_Errhandler)(intptr_t)(MPI_Errhandler_c2f(local_errhandler));
}
...
******************************************************/
void MPI_SESSION_FINALIZE(MPI_Fint * session, MPI_Fint * ierr)
{
  MPI_Session local_session;
  local_session = MPI_Session_f2c(*session);
  *ierr = MPI_Session_finalize(&local_session);
  *session = MPI_Session_c2f(local_session);
}
...
******************************************************/
void mpi_session_finalize_(MPI_Fint * session, MPI_Fint * ierr)
{
  MPI_SESSION_FINALIZE(session, ierr);
}
...
******************************************************/
void mpi_session_finalize__(MPI_Fint * session, MPI_Fint * ierr)
{
  MPI_SESSION_FINALIZE(session, ierr);
}
...
void MPI_SESSION_GET_ERRHANDLER(MPI_Fint * session, MPI_Errhandler* errhandler, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Session_get_errhandler( MPI_Session_f2c(*session), errhandler);
}
...
{
  MPI_Info local_info;
  *ierr = MPI_Session_get_info( MPI_Session_f2c(*session), &local_info) ; 
...
void MPI_SESSION_GET_NTH_PSET(MPI_Fint * session, MPI_Fint * info, MPI_Fint * n, int * pset_len, char * pset_name, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Session_get_nth_pset( MPI_Session_f2c(*session), MPI_Info_f2c(*info), *n, pset_len, pset_name);
}
...
void MPI_SESSION_GET_NUM_PSETS(MPI_Fint * session, MPI_Fint * info, int * npset_names, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Session_get_num_psets( MPI_Session_f2c(*session), MPI_Info_c2f(*info), npset_names);
}
...
******************************************************/
void MPI_SESSION_GET_PSET_INFO(MPI_Fint * session, char * pset_name, MPI_Info * info, MPI_Fint * ierr, int ps_len)
{
  MPI_Info local_info;
  TAU_MPICH3_CONST char * local_pset_name = (TAU_MPICH3_CONST char *)trim_fortran_string(pset_name, ps_len);
  *ierr = MPI_Session_get_pset_info( MPI_Session_f2c(*session), local_pset_name, &local_info);
  *info = MPI_Info_c2f(local_info);
  free((void*)local_pset_name);
}
...
void mpi_session_get_pset_info(MPI_Fint * session, char * pset_name, MPI_Info * info, MPI_Fint * ierr, int ps_len)
{
  MPI_SESSION_GET_PSET_INFO(session, pset_name, info, ierr, ps_len);
}

/******************************************************
***      MPI_Session_get_pset_info wrapper function (lowercase_)
******************************************************/
void mpi_session_get_pset_info_(MPI_Fint * session, char * pset_name, MPI_Info * info, MPI_Fint * ierr, int ps_len)
{
  MPI_SESSION_GET_PSET_INFO(session, pset_name, info, ierr, ps_len);
}
...
******************************************************/
void mpi_session_get_pset_info__(MPI_Fint * session, char * pset_name, MPI_Info * info, MPI_Fint * ierr, int ps_len)
{
  MPI_SESSION_GET_PSET_INFO(session, pset_name, info, ierr, ps_len);
}
...
******************************************************/
void MPI_SESSION_INIT(MPI_Fint * info, MPI_Fint * errhandler, MPI_Fint * session, MPI_Fint * ierr)
{
  MPI_Session local_session;
  *ierr = MPI_Session_init( MPI_Info_f2c(*info), MPI_Errhandler_f2c(*errhandler), &local_session);
  *session =  MPI_Session_c2f(local_session);
}
...
******************************************************/
void mpi_session_init_(MPI_Fint * info, MPI_Fint * errhandler, MPI_Fint * session, MPI_Fint * ierr)
{
  MPI_SESSION_INIT(info, errhandler, session, ierr);
}
...
******************************************************/
void mpi_session_init__(MPI_Fint * info, MPI_Fint * errhandler, MPI_Fint * session, MPI_Fint * ierr)
{
  MPI_SESSION_INIT(info, errhandler, session, ierr);
}
...
void MPI_SESSION_SET_ERRHANDLER(MPI_Fint * session, MPI_Fint * errhandler, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Session_set_errhandler( MPI_Session_f2c(*session), MPI_Errhandler_f2c(*errhandler));
}
...
int MPI_Ssend_c(TAU_MPICH3_CONST void* buf, MPI_Count count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm)
{
  ...
  TAU_SSENDC_DATA(typesize*count);
  TAU_PROFILE_STOP(t);
  return retvalue;
}
...
******************************************************/
void MPI_SSEND_C(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{

  *ierr = MPI_Ssend_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm));
}
...
******************************************************/
void mpi_ssend_c_(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_SSEND_C(buf, count, datatype, dest, tag, comm, ierr);
}
...
******************************************************/
void mpi_ssend_c__(MPI_Aint * buf, MPI_Count * count, MPI_Fint * datatype, MPI_Fint * dest, MPI_Fint * tag, MPI_Fint * comm, MPI_Fint * ierr)
{
  MPI_SSEND_C(buf, count, datatype, dest, tag, comm, ierr);
}
...
{
  MPI_Request local_request;
  *ierr = MPI_Ssend_init_c(buf, *count, MPI_Type_f2c(*datatype), *dest, *tag, MPI_Comm_f2c(*comm), &local_request);
  *request = MPI_Request_c2f(local_request);
}
...
******************************************************/
void MPI_STATUS_SET_ELEMENTS_C(MPI_Fint * status, MPI_Fint * datatype, MPI_Count * count, MPI_Fint * ierr)
{
  MPI_Status local_status; 
  MPI_Status_f2c(status, &local_status);
  *ierr = MPI_Status_set_elements_c(&local_status, MPI_Type_f2c(*datatype), *count);
  MPI_Status_c2f(&local_status, status);
}
...
******************************************************/
void mpi_status_set_elements_c_(MPI_Fint * status, MPI_Fint * datatype, MPI_Count * count, MPI_Fint * ierr)
{
  MPI_STATUS_SET_ELEMENTS_C(status, datatype, count, ierr);
}
...
******************************************************/
void mpi_status_set_elements_c__(MPI_Fint * status, MPI_Fint * datatype, MPI_Count * count, MPI_Fint * ierr)
{
  MPI_STATUS_SET_ELEMENTS_C(status, datatype, count, ierr);
}
...
******************************************************/
void MPI_TYPE_CONTIGUOUS_C(MPI_Count * count, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_contiguous_c(*count, MPI_Type_f2c(*oldtype), &local_newtype);
...
******************************************************/
void mpi_type_contiguous_c_(MPI_Count * count, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_TYPE_CONTIGUOUS_C(count, oldtype, newtype, ierr);
}
...
******************************************************/
void mpi_type_contiguous_c__(MPI_Count * count, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_TYPE_CONTIGUOUS_C(count, oldtype, newtype, ierr);
}
...
TAU_MPICH3_CONST int *array_of_dargs, TAU_MPICH3_CONST int *array_of_psizes, int order, MPI_Datatype oldtype, MPI_Datatype* newtype)
{
  int retvalue;
...
******************************************************/
void MPI_TYPE_CREATE_DARRAY_C(MPI_Fint * size, MPI_Fint * rank, MPI_Fint * ndims, MPI_Count * array_of_gsizes, MPI_Fint * array_of_distribs, 
MPI_Fint * array_of_dargs, MPI_Fint * array_of_psizes, MPI_Fint * order, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_create_darray_c(*size, *rank, *ndims, array_of_gsizes, array_of_distribs, array_of_dargs,
    array_of_psizes, *order, MPI_Type_f2c(*oldtype), &local_newtype);
  *newtype = MPI_Type_c2f(local_newtype);
}
...
******************************************************/
void mpi_type_create_darray_c_(MPI_Fint * size, MPI_Fint * rank, MPI_Fint * ndims, MPI_Count * array_of_gsizes, MPI_Fint * array_of_distribs, 
MPI_Fint * array_of_dargs, MPI_Fint * array_of_psizes, MPI_Fint * order, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_TYPE_CREATE_DARRAY_C(size, rank, ndims, array_of_gsizes, array_of_distribs, array_of_dargs,
    array_of_psizes, order, oldtype, newtype, ierr);
...
******************************************************/
void mpi_type_create_darray_c__(MPI_Fint * size, MPI_Fint * rank, MPI_Fint * ndims, MPI_Count * array_of_gsizes, MPI_Fint * array_of_distribs, 
MPI_Fint * array_of_dargs, MPI_Fint * array_of_psizes, MPI_Fint * order, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_TYPE_CREATE_DARRAY_C(size, rank, ndims, array_of_gsizes, array_of_distribs, array_of_dargs,
    array_of_psizes, order, oldtype, newtype, ierr);
...
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_create_hindexed_c(*count, array_of_blocklengths, array_of_displacements, MPI_Type_f2c(*oldtype), &local_newtype);
  *newtype = MPI_Type_c2f(local_newtype);
}
...
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_create_indexed_block_c(*count, *blocklength, array_of_displacements, MPI_Type_f2c(*oldtype), &local_newtype);
  *newtype = MPI_Type_c2f(local_newtype);
}
...
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_create_hindexed_block_c(*count, *blocklength, array_of_displacements, MPI_Type_f2c(*oldtype), &local_newtype);
  *newtype = MPI_Type_c2f(local_newtype);
}
...
******************************************************/
void MPI_TYPE_CREATE_HVECTOR_C(MPI_Count * count, MPI_Count * blocklength, MPI_Count * stride, MPI_Fint * oldtype, MPI_Fint * newtype,
MPI_Fint * ierr)
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_create_hvector_c(*count, *blocklength, *stride, MPI_Type_f2c(*oldtype), &local_newtype);
  *newtype = MPI_Type_c2f(local_newtype);
}
...
******************************************************/
void mpi_type_create_hvector_c_(MPI_Count * count, MPI_Count * blocklength, MPI_Count * stride, MPI_Fint * oldtype, MPI_Fint * newtype,
MPI_Fint * ierr)
{
  MPI_TYPE_CREATE_HVECTOR_C(count, blocklength, stride, oldtype, newtype, ierr);
}
...
******************************************************/
void mpi_type_create_hvector_c__(MPI_Count * count, MPI_Count * blocklength, MPI_Count * stride, MPI_Fint * oldtype, MPI_Fint * newtype,
MPI_Fint * ierr)
{
  MPI_TYPE_CREATE_HVECTOR_C(count, blocklength, stride, oldtype, newtype, ierr);
}
...
******************************************************/
void MPI_TYPE_CREATE_RESIZED_C(MPI_Fint * oldtype, MPI_Count * lb, MPI_Count * extent, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_Datatype local_newtype; 
  *ierr = MPI_Type_create_resized_c( MPI_Type_f2c(*oldtype), *lb, *extent, &local_newtype) ; 
  *newtype = MPI_Type_c2f(local_newtype);
}
...
******************************************************/
void mpi_type_create_resized_c_(MPI_Fint * oldtype, MPI_Count * lb, MPI_Count * extent, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_TYPE_CREATE_RESIZED_C(oldtype, lb, extent, newtype, ierr);
}
...
******************************************************/
void mpi_type_create_resized_c__(MPI_Fint * oldtype, MPI_Count * lb, MPI_Count * extent, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_TYPE_CREATE_RESIZED_C(oldtype, lb, extent, newtype, ierr);
}
...
MPI_Count * array_of_starts, MPI_Fint * order, MPI_Fint * oldtype, MPI_Fint * newtype, MPI_Fint * ierr)
{
  MPI_Datatype local_newtype; 
  *ierr = MPI_Type_create_subarray_c( *ndims, array_of_sizes, array_of_subsizes, array_of_starts, 
    *order, MPI_Type_f2c(*oldtype), &local_newtype) ; 
  *newtype = MPI_Type_c2f(local_newtype);
}
...
MPI_Count * array_of_large_counts, MPI_Fint * array_of_datatypes, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Type_get_contents_c(MPI_Type_f2c(*datatype), *max_integers, *max_addresses,
    *max_large_counts, *max_datatypes, array_of_integers, array_of_addresses, array_of_large_counts, local_types);
...
MPI_Count * num_datatypes, int * combiner, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Type_get_envelope_c( MPI_Type_f2c(*datatype), num_integers, num_addresses, num_large_counts, num_datatypes, combiner);
}
...
MPI_Count * num_datatypes, int * combiner, MPI_Fint * ierr)
{
  MPI_TYPE_GET_ENVELOPE_C(datatype, num_integers, num_addresses, num_large_counts, num_datatypes, combiner, ierr);
}
...
void MPI_TYPE_GET_EXTENT_C(MPI_Fint * datatype, MPI_Count * lb, MPI_Count * extent, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Type_get_extent_c( MPI_Type_f2c(*datatype), lb, extent);
}
...
void MPI_TYPE_GET_TRUE_EXTENT_C(MPI_Fint * datatype, MPI_Count * true_lb, MPI_Count * true_extent, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Type_get_true_extent_c( MPI_Type_f2c(*datatype), true_lb, true_extent);
}
...
{
  MPI_Datatype local_newtype;
  *ierr = MPI_Type_indexed_c(*count, array_of_blocklengths, array_of_displacements, MPI_Type_f2c(*oldtype), &local_newtype );
  *newtype = MPI_Type_c2f(local_newtype);
}
...
void MPI_TYPE_SIZE_C(MPI_Fint * datatype, MPI_Count * size, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Type_size_c( MPI_Type_f2c(*datatype), size);
}
...
******************************************************/
void MPI_TYPE_VECTOR_C(MPI_Count * count, MPI_Count * blocklength, MPI_Count * stride, MPI_Fint * oldtype, MPI_Fint * newtype,
MPI_Fint * ierr)
{
  MPI_Datatype local_new_type;
  *ierr = MPI_Type_vector_c(*count, *blocklength, *stride, MPI_Type_f2c(*oldtype), &local_new_type );
...
******************************************************/
void mpi_type_vector_c_(MPI_Count * count, MPI_Count * blocklength, MPI_Count * stride, MPI_Fint * oldtype, MPI_Fint * newtype,
MPI_Fint * ierr)
{
  MPI_TYPE_VECTOR_C(count, blocklength, stride, oldtype, newtype, ierr);
}
...
******************************************************/
void mpi_type_vector_c__(MPI_Count * count, MPI_Count * blocklength, MPI_Count * stride, MPI_Fint * oldtype, MPI_Fint * newtype,
MPI_Fint * ierr)
{
  MPI_TYPE_VECTOR_C(count, blocklength, stride, oldtype, newtype, ierr);
}
...
MPI_Fint * datatype, MPI_Fint * comm, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Unpack_c(inbuf, *insize, position, outbuf, *outcount, MPI_Type_f2c(*datatype), MPI_Comm_f2c(*comm));
}
...
MPI_Count * outcount, MPI_Fint * datatype, MPI_Fint * ierr, int dr_len)
{
  TAU_MPICH3_CONST char * local_datarep = (TAU_MPICH3_CONST char *)trim_fortran_string(datarep, dr_len);
  *ierr = MPI_Unpack_external_c(local_datarep, inbuf, *insize, position, outbuf, *outcount, MPI_Type_f2c(*datatype));
  free((void*)local_datarep);
}
...
MPI_Count * outcount, MPI_Fint * datatype, MPI_Fint * ierr, int dr_len)
{
  MPI_UNPACK_EXTERNAL_C(datarep, inbuf, insize, position, outbuf, outcount, datatype, ierr, dr_len);
}
...
{
  MPI_Win local_win;
  *ierr = MPI_Win_allocate_c( *size, *disp_unit, MPI_Info_f2c(*info), MPI_Comm_f2c(*comm), baseptr, &local_win) ; 
...
{
  MPI_Win local_win;
  *ierr = MPI_Win_allocate_shared_c(*size, *disp_unit, MPI_Info_f2c(*info), MPI_Comm_f2c(*comm), baseptr,  &local_win) ; 
  *win = MPI_Win_c2f(local_win);
}
...
void MPI_WIN_SHARED_QUERY_C(MPI_Fint * win, MPI_Fint * rank, MPI_Aint * size, MPI_Aint * disp_unit, MPI_Aint * baseptr, MPI_Fint * ierr)
{
  ...
  *ierr = MPI_Win_shared_query_c( MPI_Win_f2c(*win), *rank, size, disp_unit, baseptr);
}
