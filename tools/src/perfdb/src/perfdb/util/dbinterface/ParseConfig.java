...
public class ParseConfig {
	...
	System.out.println(parser.getPerfDBHome());
	System.out.println(parser.getJDBCJarFile());
	System.out.println(parser.getJDBCDriver());
	System.out.println(parser.getDBType());
	System.out.println(parser.getDBHost());
	System.out.println(parser.getDBPort());
	System.out.println(parser.getDBName());
	System.out.println(parser.getDBUserName());
	System.out.println(parser.getDBPasswd());
	System.out.println(parser.getDBSchema());
	System.out.println(parser.getXMLSAXParser());
