/*
 * This Class is distributed by Sun as a stand-alone HTTP server.  This class
 * is used in PerfExplorer as the RMI server for the analysis server.  The
 * code below was taken from the RMI example and included unmodified.
 *
 * <P>CVS $Id: ClassFileServer.java,v 1.1 2005/07/05 22:29:53 amorris Exp $</P>
 * @author  Kevin Huck
 * @version 0.1
 * @since   0.1
 */
