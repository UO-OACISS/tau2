 ...
 *
 * <P>CVS $Id: TimerThread.java,v 1.5 2007/01/04 21:20:04 khuck Exp $</P>
 * @author  Kevin Huck
 * @version 0.1
 * @since   0.1
...
public class TimerThread extends Timer implements Runnable {
	...
	public void run() {
		...
		AnalysisTask(this.server, this.workerSession, this.analysisEngine);
