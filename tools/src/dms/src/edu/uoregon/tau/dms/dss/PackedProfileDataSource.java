 ...
 *
 * <P>CVS $Id: PackedProfileDataSource.java,v 1.4 2005/05/31 23:21:02 amorris Exp $</P>
 * @author  Alan Morris
...
public class PackedProfileDataSource extends DataSource {
     ...
     * 
     * @see edu.uoregon.tau.dms.dss.DataSource#cancelLoad()
     */
     ...
     * 
     * @see edu.uoregon.tau.dms.dss.DataSource#load()
     */
