...
public class Configure {
    ...
    private static String Greeting = "\nWelcome to the configuration program for PerfDMFF.\n" +
...
*/
	    ...
	    if (configFileFound)
		System.out.print("Please enter the PerfDMFF schema file.\n(" + db_schemafile + "):");
	    else
	...
	try {
	    ...
	    configWriter.write("# This is the configuration file for the PerfDMFF tools & API\n");
