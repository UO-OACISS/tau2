 ...
 * 
 * <P>
 * CVS $Id: DataSession.java,v 1.8 2004/12/21 00:33:29 amorris Exp $
 * </P>
 * 
...
public abstract class DataSession {
    ...
    //######
    //End - Object structure representation of data mirrored on ParaProf's
    // usage.
    //######
     ...
     *            an implementation-specific object required to initialize the
     *            DataSession
     */
     ...
     * 
     * @return DataSessionIterator object of all Experiments. If there is an
     *         Application saved in the DataSession, then only the Experiments
     *         for that Application are returned.
     * @see DataSessionIterator
     * @see Experiment
     ...
     * 
     * @return DataSessionIterator object of all Trials. If there is an
     *         Application and/or Experiment saved in the DataSession, then only
     *         the Trials for that Application and/or Experiment are returned.
     * @see DataSessionIterator
     * @see Trial
     * @see DataSession#setApplication
    ...
    /**
     * Set the Application for this DataSession. The DataSession object will
     * maintain a reference to the Application object. To clear this reference,
     * call setApplication(Application) with a null reference.
     * 
     * @param application
     *            Application object to be saved.
     * @see Application
     */
    ...
    /**
     * Set the Application for this DataSession. The DataSession object will
     * maintain a reference to the Application referenced by the id. To clear
     * this reference, call setApplication(Application) with a null reference.
     * 
     * @param id
     *            unique id of the Application object to be saved.
     * @see Application
    ...
    /**
     * Set the Application for this DataSession. The DataSession object will
     * maintain a reference to the Application referenced by the name and/or
     * version. To clear this reference, call setApplication(Application) with a
     * null reference.
     * 
     * @param name
     *            name of the Application object to be saved.
     * @param version
     *            version of the Application object to be saved.
     * @see Application
     * @see DataSession#setApplication(Application)
     */
    ...
    /**
     * Set the Experiment for this DataSession. The DataSession object will
     * maintain a reference to the Experiment object. To clear this reference,
     * call setExperiment(Experiment) with a null reference.
     * 
     * @param experiment
     *            Experiment object to be saved.
     * @see Experiment
     */
    public void setExperiment(Experiment experiment) {
        this.experiment = experiment;
        /*
         * don't know if we want to do this... if (this.application == null &&
    ...
    /**
     * Set the Experiment for this DataSession. The DataSession object will
     * maintain a reference to the Experiment referenced by the id. To clear
     * this reference, call setExperiment(Experiment) with a null reference.
     * 
     * @param id
     *            unique id of the Experiment object to be saved.
     * @see Experiment
    ...
    /**
     * Set the Trial for this DataSession. The DataSession object will maintain
     * a reference to the Trial object. To clear this reference, call
     * setTrial(Trial) with a null reference.
     * 
     * @param trial
     *            Trial object to be saved.
     * @see Trial
     */
    public void setTrial(Trial trial) {
        this.trial = trial;
        /*
         * don't know if we want to do this if (this.experiment == null &&
         * this.trial != null) { setExperiment(trial.getExperimentID()); }
         */
    }

    /**
     * Set the Trial for this DataSession. The DataSession object will maintain
     * a reference to the Trial referenced by the id. To clear this reference,
     * call setTrial(Trial) with a null reference.
     * 
     * @param id
     *            unique id of the Trial object to be saved.
     * @see Trial
    ...
    /**
     * Set the node for this DataSession. The DataSession object will maintain
     * the value of the node identified by the id. To clear this value, call
     * setNode(int) with DataSession.PERFDMF_NONE.
     * 
     * @param node
     *            value of the node to be saved.
    ...
    /**
     * Set a Vector of node values for this DataSession. The DataSession object
     * will maintain a reference to the Vector of node values. To clear this
     * reference, call setNode(int) with DataSession.PERFDMF_NONE.
     * 
     * @param nodes
     *            Vector of node values to be saved.
     * @see DataSession#PERFDMF_NONE
     */
    ...
    /**
     * Set the context for this DataSession. The DataSession object will
     * maintain the value of the context identified by the id. To clear this
     * value, call setContext(int) with DataSession.PERFDMF_NONE.
     * 
     * @param context
     *            value of the context to be saved.
     * @see DataSession#PERFDMF_NONE
     */
    ...
    /**
     * Set a Vector of context values for this DataSession. The DataSession
     * object will maintain a reference to the Vector of context values. To
     * clear this reference, call setContext(int) with DataSession.PERFDMF_NONE.
     * 
     * @param contexts
     *            Vector of context values to be saved.
     * @see DataSession#PERFDMF_NONE
     */
    ...
    /**
     * Set the thread for this DataSession. The DataSession object will maintain
     * the value of the thread identified by the id. To clear this value, call
     * setThread(int) with DataSession.PERFDMF_NONE.
     * 
     * @param thread
     *            value of the thread to be saved.
     * @see DataSession#PERFDMF_NONE
     */
    ...
    /**
     * Set a Vector of thread values for this DataSession. The DataSession
     * object will maintain a reference to the Vector of thread values. To clear
     * this reference, call setThread(int) with DataSession.PERFDMF_NONE.
     * 
     * @param threads
     *            Vector of thread values to be saved.
     * @see DataSession#PERFDMF_NONE
     */
    ...
    /**
     * Set the metric for this DataSession. The DataSession object will maintain
     * the value of the metric identified by the String. To clear this value,
     * call setMetric(Metric) with null.
     * 
     * @param metric
     *            value of the metric to be saved.
     */
    ...
    /**
     * Get the metric id corresponding to the given string. The DataSession
     * object will maintain a reference to the Vector of metric values. To clear
     * this reference, call setMetric(String) with null.
     * 
     * @param string
     ...
     * 
     * @return DataSessionIterator object of all IntervalEvents. If there is an
     *         Application, Experiment, Trial(s), node(s), context(s) and/or
     *         thread(s) saved in the DataSession, then only the IntervalEvents
     *         for that Application, Experiment, Trial(s), node(s), context(s)
     *         and/or thread(s) are returned.
     * @see DataSessionIterator
     * @see IntervalEvent
     * @see DataSession#setApplication
     * @see DataSession#setExperiment
    ...
    /**
     * Set the IntervalEvent for this DataSession. The DataSession object will
     * maintain a reference to the IntervalEvent object. To clear this
     * reference, call setIntervalEvent(IntervalEvent) with a null reference.
     * 
     * @param intervalEvent
     *            IntervalEvent object to be saved.
     * @see IntervalEvent
    ...
    /**
     * Set the IntervalEvent for this DataSession. The DataSession object will
     * maintain a reference to the IntervalEvent referenced by the id. To clear
     * this reference, call setIntervalEvent(IntervalEvent) with a null
     * reference.
     * 
     * @param id
     *            unique id of the IntervalEvent object to be saved.
     * @see IntervalEvent
     * @see DataSession#setIntervalEvent(IntervalEvent)
     */
    ...
    /**
     * Set a Vector of IntervalEvent objects for this DataSession. The
     * DataSession object will maintain a reference to a Vector of IntervalEvent
     * objects. To clear this reference, call setIntervalEvent(IntervalEvent)
     * with a null reference.
     * 
     * @param intervalEvents
     *            Vector of IntervalEvent objects to be saved.
     * @see IntervalEvent
     * @see DataSession#setIntervalEvent(IntervalEvent)
     */
     ...
     * 
     * @param intervalEventID
     *            unique id of the IntervalEvent object.
     ...
     * 
     * @return DataSessionIterator object of all AtomicEvents. If there is an
     *         Application, Experiment, Trial(s), node(s), context(s) and/or
     *         thread(s) saved in the DataSession, then only the AtomicEvents
     *         for that Application, Experiment, Trial(s), node(s), context(s)
     *         and/or thread(s) are returned.
     * @see DataSessionIterator
     * @see AtomicEvent
    ...
    /**
     * Set the AtomicEvent for this DataSession. The DataSession object will
     * maintain a reference to the AtomicEvent object. To clear this reference,
     * call setAtomicEvent(AtomicEvent) with a null reference.
     * 
     * @param atomicEvent
     *            AtomicEvent object to be saved.
     * @see AtomicEvent
    ...
    /**
     * Set the AtomicEvent for this DataSession. The DataSession object will
     * maintain a reference to the AtomicEvent referenced by the id. To clear
     * this reference, call setAtomicEvent(AtomicEvent) with a null reference.
     * 
     * @param id
     *            unique id of the AtomicEvent object to be saved.
     * @see AtomicEvent
     * @see DataSession#setAtomicEvent(AtomicEvent)
     */
    ...
    /**
     * Set a Vector of AtomicEvent objects for this DataSession. The DataSession
     * object will maintain a reference to a Vector of AtomicEvent objects. To
     * clear this reference, call setAtomicEvent(AtomicEvent) with a null
     * reference.
     * 
     * @param atomicEvents
     *            Vector of AtomicEvent objects to be saved.
     * @see AtomicEvent
     * @see DataSession#setAtomicEvent(AtomicEvent)
     */
     ...
     * 
     * @return DataSessionIterator of IntervalEventData objects. If there is an
     *         Application, Experiment, Trial(s), node(s), context(s), thread(s)
     *         and/or IntervalEvent(s) saved in the DataSession, then only the
     *         IntervalEvents for that Application, Experiment, Trial(s),
     *         node(s), context(s), thread(s) and/or IntervalEvent(s) are
     *         returned.
     * @see DataSessionIterator
     ...
     * 
     * @return DataSessionIterator of AtomicEventData objects. If there is an
     *         Application, Experiment, Trial(s), node(s), context(s), thread(s)
     *         and/or IntervalEvent(s) saved in the DataSession, then only the
     *         AtomicEvents for that Application, Experiment, Trial(s), node(s),
     *         context(s), thread(s) and/or IntervalEvent(s) are returned.
     * @see DataSessionIterator
     ...
     */
    abstract public int saveIntervalEvent(IntervalEvent intervalEvent,
            int newTrialID, Hashtable newMetHash);
     ...
     */
    abstract public void saveIntervalEventData(
            IntervalLocationProfile intervalEventData, int newIntervalEventID,
            Hashtable newMetHash);
     ...
     */
    abstract public void saveAtomicEventData(
            AtomicLocationProfile atomicEventData, int newAtomicEventID);
     ...
     *
     * @param trialData TrialData object.
     */
