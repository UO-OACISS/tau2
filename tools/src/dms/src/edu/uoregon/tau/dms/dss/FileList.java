...
//                                    "Choose one or more files OR a single directory", "File Selection Error",
...
//                                            && (files[i].getName().indexOf("MULTI__") != -1))
//                                        v.add(files[i]);
//                                }
//                            }
//                            int length = v.size();
...
//                    int index = 0;
//                    Vector v = new Vector();
//                    file = new File(directoryPath + fileSeparator + filePrefix + fileSeparator + index
