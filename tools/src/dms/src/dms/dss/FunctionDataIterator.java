 ...
 *
 * <P>CVS $Id: FunctionDataIterator.java,v 1.1 2004/03/27 01:02:56 khuck Exp $</P>
 ...
 *
 * @param	size number of objects in following arrays
 * @param	metricCount number of metrics in the arrays
 * @param	node node ids
 * @param	context context ids
 * @param	thread thread ids
 * @param	function function ids
 * @param	numCalls number of calls for each function at each node, context, thread
 * @param	numSubroutines number of subroutines for each function
