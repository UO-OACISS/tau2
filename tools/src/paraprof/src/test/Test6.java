...
public class MappingDataWindow extends JFrame implements ActionListener, MenuListener, Observer, ChangeListener, AdjustmentListener
{
  ...
  public void paint(Graphics g){
                ...
                Dimension pref = mappingDataWinPanelRef.getPreferredSize();
                Dimension size = mappingDataWinPanelRef.getSize();
                
                
        Dimension windowSize = this.getSize();
        
                System.out.println("Pref is:" + pref.width + "," + pref.height);
                System.out.println("Size is:" + size.width + "," + size.height);
                System.out.println("Window size is:" + windowSize.width + "," + windowSize.height);
