...
public class Gears extends JFrame {
  ...
  public static class GearRenderer implements GLEventListener, MouseListener, MouseMotionListener {
    ...
    public void display(GLDrawable drawable) {
      ...
      drawable.setRenderingThread(java.lang.Thread.currentThread());
