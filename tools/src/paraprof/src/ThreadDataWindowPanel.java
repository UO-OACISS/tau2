...
public class ThreadDataWindowPanel extends JPanel implements ActionListener, MouseListener, Printable{
	...
	try
		...
		if ((clipRect != null))
			...
			maxInclusiveValue = thread.getMaxInclusiveValue(trial.getCurValLoc());
			maxExclusiveValue = thread.getMaxExclusiveValue(trial.getCurValLoc());
			maxInclusivePercentValue = thread.getMaxInclusivePercentValue(trial.getCurValLoc());
			maxExclusivePercentValue = thread.getMaxExclusivePercentValue(trial.getCurValLoc());
			maxNumberOfCalls = thread.getMaxNumberOfCalls();
			maxNumberOfSubroutines = thread.getMaxNumberOfSubRoutines();
			maxUserSecPerCall = thread.getMaxUserSecPerCall(trial.getCurValLoc());
