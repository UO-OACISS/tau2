...
//     public static void exportSVGd(ImageExport ie) throws Exception {
//         //Ask the user for a filename and location.
//         JFileChooser fileChooser = new JFileChooser();
...
//         ParaProfImageOptionsPanel paraProfImageOptionsPanel = new ParaProfImageOptionsPanel((Component) ie, true, true);
...
//         ie.export(svgGenerator, false, paraProfImageOptionsPanel.isFullScreen(), paraProfImageOptionsPanel.isPrependHeader());
...
//     public static void exportEPS3(ImageExport ie) throws Exception {
//         //Ask the user for a filename and location.
//         JFileChooser fileChooser = new JFileChooser();
//         fileChooser.setDialogTitle("Save EPS File");
//         //Set the directory.
//         fileChooser.setCurrentDirectory(new File(System.getProperty("user.dir")));
//         //Get the current file filters.
//         javax.swing.filechooser.FileFilter fileFilters[] = fileChooser.getChoosableFileFilters();
...
//         FileOutputStream outputStream = new FileOutputStream(file);
//         Dimension d = ie.getImageSize(paraProfImageOptionsPanel.isFullScreen(), paraProfImageOptionsPanel.isPrependHeader());
//         EpsGraphics2D g = new EpsGraphics2D("ParaProf", outputStream, 0, 0, d.width, d.height);
//         // Turn off accurate text mode
//         g.setAccurateTextMode(false);
//         ie.export(g, false, paraProfImageOptionsPanel.isFullScreen(), paraProfImageOptionsPanel.isPrependHeader());
//         g.flush();
//         g.close();
//     }

//     public static void exportEPS(ImageExport ie) throws Exception {
//         //Ask the user for a filename and location.
//         JFileChooser fileChooser = new JFileChooser();
//         fileChooser.setDialogTitle("Save EPS File");
//         //Set the directory.
