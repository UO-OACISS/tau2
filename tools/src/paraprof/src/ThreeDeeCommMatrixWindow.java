...
public class ThreeDeeCommMatrixWindow implements ParaProfWindow, Printable {
    ...
    private ThreeDeeCommMatrixWindow(ParaProfTrial ppTrial) {
        this.ppTrial = ppTrial;
    }

    public static JFrame createCommunicationMatrixWindow(ParaProfTrial ppTrial, JFrame parentFrame) {
        ThreeDeeCommMatrixWindow matrix = new ThreeDeeCommMatrixWindow(ppTrial);
        ...
        JMenu fileMenu = ParaProfUtils.createFileMenu(matrix, matrix, frame);
        fileMenu.getPopupMenu().setLightWeightPopupEnabled(false);
        mainMenu.add(fileMenu);
        
        JMenu windowsMenu = ParaProfUtils.createWindowsMenu(ppTrial, frame);
        windowsMenu.getPopupMenu().setLightWeightPopupEnabled(false);
        mainMenu.add(windowsMenu);
        
        JMenu helpMenu = ParaProfUtils.createHelpMenu(frame, matrix);
