...
public class ParaProfImageOutput {
    ...
    public void saveImage(ParaProfImageInterface ref) throws ParaProfException, IOException {
            ...
            fileChooser.addChoosableFileFilter(new ParaProfImageFormatFileFilter(
                    ParaProfImageFormatFileFilter.PNG));
            fileChooser.addChoosableFileFilter(new ParaProfImageFormatFileFilter(
                    ParaProfImageFormatFileFilter.JPG));
            fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);

            ParaProfImageOptionsPanel paraProfImageOptionsPanel = new ParaProfImageOptionsPanel(
                    (Component) ref);
