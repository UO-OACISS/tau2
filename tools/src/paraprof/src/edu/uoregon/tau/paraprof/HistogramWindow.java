...
/*
 To do: Fix the getData and storeData functionProfiles.
 1) 
 */
...
public class HistogramWindow extends JFrame implements ActionListener, MenuListener, Observer {
    ...
    public HistogramWindow(ParaProfTrial trial, DataSorter dataSorter, boolean normal,
        ...
        try {
            ...
            //######
            panel = new HistogramWindowPanel(trial, this, normal, function, this.debug());
