...
{ 
    ...
    try{
      ...
      if(EventSrc instanceof JMenuItem)
      {
        ...
        if(arg.equals("Pprof Dump File"))
        {
          ...
          if(resultValue == JFileChooser.APPROVE_OPTION)
          {
            ...
            { 
              ...
              ParaProf.profilePathName = file.getCanonicalPath();
        
              setTitle("ParaProf: " + ParaProf.profilePathName);
              
              //Initialize the static data object.
              ParaProf.staticSystemData = new Trial();
              ...
              ParaProf.clrChooser.setHighlightColorMappingID(-1);
        ...
        */
        ...
        else if(arg.equals("ParaProf Output File"))
        { 
          /*
          //Set the directory to the current directory.
          ...
          if(resultValue == JFileChooser.APPROVE_OPTION)
          {
            ...
            if(file != null)
            {
              ...
              try
              {
                ...
                ParaProf.staticSystemData = (Trial) racyDataObjectIn.readObject();
              }
              catch(Exception e)
              {
                ParaProf.systemError(e, null, "SMW02A");
              }
          ...
          if(resultValue == JFileChooser.APPROVE_OPTION)
          {
            ...
            if(file != null)
            {
              try
              {
                ...
                experimentOut.writeObject(ParaProf.staticSystemData);
                experimentOut.close();
              ...
              {
                //Display an error
                JOptionPane.showMessageDialog(this, "An error occured whilst trying to save ParaProf output file.", "Error!"
                                  ,JOptionPane.ERROR_MESSAGE);
              }
            }
            else
  ...
  public boolean isDataLoaded()
  {
    ...
    {
      ParaProf.systemError(e, null, "SMW09");
    }
