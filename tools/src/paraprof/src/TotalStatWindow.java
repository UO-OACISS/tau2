...
public class TotalStatWindow extends JFrame implements ActionListener, MenuListener, Observer 
{
	...
	try{
	    ...
	    {
		ParaProf.systemError(e, null, "TSW01");
	    }
    }
  
    public TotalStatWindow(Trial inTrial,
			   int inServerNumber,
			   int inContextNumber,
			   int inThreadNumber,
	...
	try{
	    ...
	    //**********
	    panel = new TotalStatWindowPanel(trial,
							       inServerNumber,
							       inContextNumber,
							       inThreadNumber, this);
	    ...
	    {
		ParaProf.systemError(e, null, "TSW02");
	    }
    }
	...
	try{
	    ...
	    ParaProf.systemError(e, null, "TSW04");
	}
    } 
	...
	try{
	    ...
	    ParaProf.systemError(e, null, "TSW05");
	}
    }
	...
	try{
	    ...
	    ParaProf.systemError(e, null, "TSW06");
	}
	...
	try
	    ...
	    {
		ParaProf.systemError(e, null, "TSW07");
	    }
    }
    ...
    private TotalStatWindowPanel panel;
