...
public class UserEventWindow extends JFrame implements ActionListener, MenuListener, Observer, ChangeListener
{
  ...
  public UserEventWindow(Trial inTrial, int inMappingID, StaticMainWindowData inSMWData)
  {
    try{
      ...
      if(ParaProf.helpWindow.isVisible())
      {
        ...
        //where they are.
        ParaProf.helpWindow.writeText("This is the user event data window for:");
        ParaProf.helpWindow.writeText(mappingName);
        ParaProf.helpWindow.writeText("");
        ParaProf.helpWindow.writeText("This window shows you this user event's statistics across all the threads.");
        ParaProf.helpWindow.writeText("");
        ...
        ParaProf.helpWindow.writeText("for this user event.");
      }
  ...
  public int getSliderValue()
  {
    ...
    {
      ParaProf.systemError(e, null, "UEW07");
    }
  ...
  public double getSliderMultiple()
  {
    ...
    {
      ParaProf.systemError(e, null, "UEW08");
    }
  ...
  private void addCompItem(Component c, GridBagConstraints gbc, int x, int y, int w, int h)
  {
    ...
    {
      ParaProf.systemError(e, null, "UEW09");
    }
  }
  ...
  void closeThisWindow()
  {
    ...
    {
      ParaProf.systemError(e, null, "UEW10");
    }
  }
