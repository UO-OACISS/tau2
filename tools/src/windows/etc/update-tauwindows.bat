...
nmake /f Makefile.win32 PDT=c:\pdtoolkit-3.3.1 tau_instrumentor
...
xcopy /e /y tools\src\windows\examples c:\tau-windows
md c:\tau-windows\tools\src\perfdmf
xcopy /e /y tools\src\perfdmf\etc c:\tau-windows\tools\src\perfdmf
